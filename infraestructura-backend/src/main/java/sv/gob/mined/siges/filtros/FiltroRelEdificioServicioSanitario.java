...
public class FiltroRelEdificioServicioSanitario implements Serializable {

    private Long edificioFk;
    ...
    public FiltroRelEdificioServicioSanitario() {
    }

    public Long getEdificioFk() {
        return edificioFk;
    }

    public void setEdificioFk(Long edificioFk) {
    ...
    public boolean equals(Object obj) {
        ...
        final FiltroRelEdificioServicioSanitario other = (FiltroRelEdificioServicioSanitario) obj;
