...
public class FiltroRelInmuebleEspacioComun implements Serializable {

    private Long inmuebleFk;
    private Long espacioComunFk;
    ...
    public FiltroRelInmuebleEspacioComun() {
    }
    ...
    public Long getEspacioComunFk() {
        return espacioComunFk;
    }

    public void setEspacioComunFk(Long espacioComunFk) {
        this.espacioComunFk = espacioComunFk;
    } 
    ...
    public boolean equals(Object obj) {
        ...
        final FiltroRelInmuebleEspacioComun other = (FiltroRelInmuebleEspacioComun) obj;
