 ...
 */
@Entity
@Table(name = "sg_inf_naturaleza_contrato", uniqueConstraints = {
...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "nacPk", scope = SgInfNaturalezaContrato.class)
@Audited
public class SgInfNaturalezaContrato implements Serializable {
    ...
    public String toString() {
        return "SgInfNaturalezaContrato{" + "nacPk=" + nacPk + ", nacCodigo=" + nacCodigo + ", nacNombre=" + nacNombre + ", nacNombreBusqueda=" + nacNombreBusqueda + ", nacHabilitado=" + nacHabilitado + ", nacUltModFecha=" + nacUltModFecha + ", nacUltModUsuario=" + nacUltModUsuario + ", nacVersion=" + nacVersion + '}';
    }
