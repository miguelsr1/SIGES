...
@JsonIdentityInfo(generator=ObjectIdGenerators.PropertyGenerator.class, property = "tisPk", scope = SgInmueblesSedesLiteObraExterior.class)
@Audited
public class SgInmueblesSedesLiteObraExterior implements Serializable {
    ...
    @OneToMany(mappedBy = "rixInmuebleSede", cascade = CascadeType.ALL, orphanRemoval = true)  
    private List<SgRelInmuebleItemObraExterior> tisObraExterior; 

   

    
    public SgInmueblesSedesLiteObraExterior() {
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SgInmueblesSedesLiteObraExterior other = (SgInmueblesSedesLiteObraExterior) obj;
