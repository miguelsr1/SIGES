...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "aulPk", scope = SgAulaLiteEspacio.class)
@Audited
public class SgAulaLiteEspacio implements Serializable {
    ...
    @OneToMany(mappedBy = "raeAula", cascade = CascadeType.ALL, orphanRemoval = true)  
    private List<SgRelAulaEspacio> aulRelAulaEspacio;


    public SgAulaLiteEspacio() {
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SgAulaLiteEspacio other = (SgAulaLiteEspacio) obj;
