...
public class HandleArchivoBean implements Serializable {
   ...
   public StreamedContent plantillaCargaIndicadorExterno() {
        InputStream stream = FacesContext.getCurrentInstance().getExternalContext().getResourceAsStream("/resources/plantillas/carga_indicador_externo.xlsx");
        return new DefaultStreamedContent(stream, "application/xls", "Plantilla para carga de indicadores externos.xlsx");
    }
