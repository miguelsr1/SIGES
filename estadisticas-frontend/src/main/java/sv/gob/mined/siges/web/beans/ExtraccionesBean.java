...
public class ExtraccionesBean implements Serializable {
    ...
    public void buscar() {
        try {
            ...
            filtro.setDatasetPk(this.comboDatasets.getSelectedT() != null ? this.comboDatasets.getSelectedT().getDatPk() : null);
    ...
    public void actualizar(SgExtraccion ext) {
        this.entidadEnEdicion = ext;
    }

    public void eliminar() {
        try {
            restClient.eliminar(entidadEnEdicion.getExtPk());
