...
public class EstadisticasEstudiantesRestClient implements Serializable {
    ...
    public List<EstGenerica> obtenerEstadisticas(FiltroEstadisticas filtro) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
        if (filtro == null) {
            return new ArrayList<>();
        }
        WebTarget webTarget = RestClient.getWebTarget(client, ConstantesServiciosRest.ESTADISTICAS, "v1/estadisticasestudiantes/obtenerestadisticas");
    ...
    public List<EstGenerica> tasaEspecificaDeEscolarizacionPorEdad(FiltroEstadisticas filtro) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
        if (filtro == null) {
            return new ArrayList<>();
        }
