...
public class IndicadorBean implements Serializable {
   ...
   private SofisComboG<EnumTipoResultadoIndicador> comboTipoResultado;
    ...
    public void cargarCombos() {
        try {
            ...
            comboTipoResultado = new SofisComboG<>(Arrays.asList(EnumTipoResultadoIndicador.values()), "text");
            comboTipoResultado.addEmptyItem(Etiquetas.getValue("comboEmptyItem"));
        } catch (Exception ex) {
    ...
    public void eliminarFoto() {
        this.entidadEnEdicion.setIndFormula(null);
    }
    ...
    public void actualizar(SgEstIndicador var) {
        ...
        this.comboTipoResultado.setSelectedT(var.getIndTipoResultado());
    }

    public void guardar() {
        try {
            entidadEnEdicion.setIndTipoResultado(this.comboTipoResultado.getSelectedT());
    ...
    public SofisComboG<EnumTipoResultadoIndicador> getComboTipoResultado() {
        return comboTipoResultado;
    }

    public void setComboTipoResultado(SofisComboG<EnumTipoResultadoIndicador> comboTipoResultado) {
        this.comboTipoResultado = comboTipoResultado;
    }
