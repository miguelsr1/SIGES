...
public class FileUploadUtils {
    ...
    public static void handleFileUpload(UploadedFile file, SgEstArchivo archivo, String tmpBasePath) {
        if (file != null) {
    ...
    public static StreamedContent handleFileDownload(SgEstArchivo archivo, String basePath) throws Exception {
        InputStream stream;
