...
public class BusinessException extends Exception {
    ...
    private List<BusinessError> erroresTextoPlano = new ArrayList();
    ...
    public List<BusinessError> getErroresTextoPlano() {
        return erroresTextoPlano;
    }

    public void setErroresTextoPlano(List<BusinessError> erroresTextoPlano) {
