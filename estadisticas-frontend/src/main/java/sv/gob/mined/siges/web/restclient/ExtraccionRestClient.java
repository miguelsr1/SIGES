...
public class ExtraccionRestClient implements Serializable {
    ...
    public SgExtraccion duplicarExtraccionParaOtroAnio(SgDuplicarExtraccion dup) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
        if (dup == null) {
            return null;
        }
        WebTarget webTarget = RestClient.getWebTarget(client, ConstantesServiciosRest.ESTADISTICAS, "v1/extracciones/duplicar");
        return restClient.invokePost(webTarget, dup, SgExtraccion.class);
    }
