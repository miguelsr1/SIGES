...
public class RestClient {
    ...
    public static WebTarget getWebTarget(String service, Object... path) {
        ...
        WebTarget target = client.target(System.getProperty("service." + service + ".baseUrl"));//service.catalogo.baseUrl
        for (Object part : path) {
            target = target.path(String.valueOf(part));//v1/categoriasoperacion
        }
        return target;
    }
