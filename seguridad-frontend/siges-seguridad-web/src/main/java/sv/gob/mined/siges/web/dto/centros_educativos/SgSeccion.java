...
public class SgSeccion implements Serializable {
    ...
    @JsonIgnore
    public String getNombreSeccionCompleto() {
        if (secJornadaLaboral != null) {
            return secAnioLectivo.getAleAnio() +" - "+secNombre + " - " + secJornadaLaboral.getJlaNombre()+" - "+secServicioEducativo.getSduNombre()+ " - "+secServicioEducativo.getSduSede().getSedCodigo()+" "+secServicioEducativo.getSduSede().getSedNombre();
        } else {
            return secNombre;
        }
    }
