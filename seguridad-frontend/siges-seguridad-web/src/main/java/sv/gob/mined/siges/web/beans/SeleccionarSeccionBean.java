...
import sv.gob.mined.siges.web.restclient.centros_educativos.AnioLectivoRestClient;
import sv.gob.mined.siges.web.restclient.centros_educativos.CicloRestClient;
import sv.gob.mined.siges.web.restclient.centros_educativos.GradoRestClient;
import sv.gob.mined.siges.web.restclient.centros_educativos.ModalidadRestClient;
import sv.gob.mined.siges.web.restclient.centros_educativos.NivelRestClient;
import sv.gob.mined.siges.web.restclient.centros_educativos.OpcionRestClient;
import sv.gob.mined.siges.web.restclient.centros_educativos.RelModEdModAtenRestClient;
import sv.gob.mined.siges.web.restclient.centros_educativos.RelOpcionProgEdRestClient;
    ...
    public void seleccionarNivel() {
        try {
            ...
            if (comboNivel.getSelectedT() != null) {
                ...
                List<SgCiclo> ciclos = restCiclo.buscar(fCiclo);
    ...
    public void seleccionarModalidad() {
        try {
            ...
            if (comboModalidad.getSelectedT() != null) {
                ...
                List<SgOpcion> opciones = restOpcion.buscar(fopcion);
    ...
    public void seleccionarOpcion() {
        try {
            ...
            if (comboOpcion.getSelectedT() != null) {
                ...
                List<SgRelOpcionProgEd> relProgramas = restProg.buscar(fprog);
    ...
    public void seleccionarGrado() {
        try {
            ...
            if (comboGrado.getSelectedT() != null) {
                ...
                fal.setAleGradoFk(comboGrado.getSelectedT().getGraPk());
                ...
                if (BooleanUtils.isNotFalse(this.retornarSoloSeccionesAbiertas)) { //True or null
                    fal.setAleSeccionEstado(EnumSeccionEstado.ABIERTA);
                }
                ...
                // Collections.sort(listAnio, (SgAnioLectivo a1, SgAnioLectivo a2) -> a1.getAleAnio() - a2.getAleAnio());
