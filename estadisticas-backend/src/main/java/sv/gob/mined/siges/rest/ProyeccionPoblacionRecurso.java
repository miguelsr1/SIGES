...
import sv.gob.mined.siges.negocio.servicios.ProyeccionesPoblacionBean;
...
public class ProyeccionPoblacionRecurso {

    private static final Logger LOGGER = Logger.getLogger(ProyeccionPoblacionRecurso.class.getName());

    @Inject
    private ProyeccionesPoblacionBean servicio;
     ...
     * @return Response Lista de SgEstProyeccionPoblacion
     */
    @POST
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Consumo satisfactorio.", content = @Content(
                ...
                schema = @Schema(implementation = SgEstProyeccionPoblacion.class, type = SchemaType.ARRAY)))
        ,
    ...
    public Response buscar(FiltroProyeccionPoblacion filtro) {
        try {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({ConstantesOperaciones.AUTENTICADO})
    public Response buscarTotal(FiltroProyeccionPoblacion filtro) {
        try {
