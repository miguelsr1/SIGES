 ...
 */
@Entity
@Table(name = "sg_tuplas_carga_externa", schema = Constantes.SCHEMA_ESTADISTICAS)
@XmlRootElement
@EntityListeners({EntidadListener.class})
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "tupPk", scope = SgTuplaCargaExterna.class)
public class SgTuplaCargaExterna implements Serializable {
    ...
    @ManyToOne
    @JoinColumn(name = "tup_carga_externa_fk")
    private SgCargaExterna tupCargaExterna;
    ...
    public SgCargaExterna getTupCargaExterna() {
        return tupCargaExterna;
    }

    public void setTupCargaExterna(SgCargaExterna tupCargaExterna) {
        this.tupCargaExterna = tupCargaExterna;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SgTuplaCargaExterna other = (SgTuplaCargaExterna) obj;
