...
@Audited
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "achPk", scope = SgEstArchivo.class)
public class SgEstArchivo implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final SgEstArchivo other = (SgEstArchivo) obj;
