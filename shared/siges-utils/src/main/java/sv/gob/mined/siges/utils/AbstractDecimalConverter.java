...
/**
 * Abstract helper class which implements the main methods for the conversion of
 * numbers to words for languages which uses the decimal system.
 *
...
public abstract class AbstractDecimalConverter
    ...
    /**
     * Mask used to format theAbstractDecimalConvertert in strings to extract
     * the numbers depending on the power.
     *
     * @see #convert(long)
     */
