...
public interface IConverter {
    ...
    /**
     * <p>
     * Returns <i>true</i> in the case the converter for a language uses the
     * short scale for the decimal system.</p>
     * <p>
     * If the language uses the decimal system ({@link #isDecimal}), two
     * different numerical systems &quot;large scale&quot; and &quot;short
     * scale&quot; exists. Sometimes used numerical system may also changed in
     * the history for one language. E.g. in the United Kindom before the second
     * world war they used the large scale system. In 1974 the UK government
     * changed to short scale for their statistics. Another example is the
     * French language. They changed after the second world war from short scale
     * to long scale.</p>
     * <p>
     * In 1948 the 9th General Conference on Weights and Measures proposed the
     * universal use of the long scale. So here this means that the usage of
     * short scale is an specialty, but could be checked with this method.</p>
     * <p>
     * The different between this two numerical systems is, that a billion in
     * short scale is not the same that in the long scale. The following table
     * gives an overview:
     * <table border="1">
     ...
     * </p>
     * <p>
     * For a deeper explanation see e.g. the description of the short and long
     * scale in the Wikipedia.</p>
     *
