...
public class SgPeriodosOrdExord implements Serializable {     
    ...
    public int hashCode() {
        int hash = 7;
        hash = 37 * hash + Objects.hashCode(this.rangoFechas);
        hash = 37 * hash + Objects.hashCode(this.periodosExtraordinarios);
        hash = 37 * hash + Objects.hashCode(this.componentesPlanGrado);
        return hash;
    }
