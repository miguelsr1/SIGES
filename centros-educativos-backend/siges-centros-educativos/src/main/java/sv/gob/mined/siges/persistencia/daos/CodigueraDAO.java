...
public class CodigueraDAO<T> extends HibernateJpaDAOImp<T, Long> implements Serializable {
    ...
    public T guardar(T elemento) throws DAOGeneralException, BusinessException {
        try {
    ...
    public T obtenerPorId(Long id, String securityOperation) throws DAOGeneralException, BusinessException {
        try {
