...
public class FiltroPersonalSedeEducativa implements Serializable {
    ...
    private List<Long> personalPk;
    private Long pseAnioFk;
    private List<String> perDuiList;
    
    private Boolean soloDeModalidadFlexible;
    ...
    public List<String> getPerDuiList() {
        return perDuiList;
    }

    public void setPerDuiList(List<String> perDuiList) {
        this.perDuiList = perDuiList;
    }
    ...
    public Boolean getSoloDeModalidadFlexible() {
        return soloDeModalidadFlexible;
    }

    public void setSoloDeModalidadFlexible(Boolean soloDeModalidadFlexible) {
        this.soloDeModalidadFlexible = soloDeModalidadFlexible;
    }

    public List<Long> getPersonalPk() {
        return personalPk;
    }

    public void setPersonalPk(List<Long> personalPk) {
        this.personalPk = personalPk;
    }

    public Long getPseAnioFk() {
        return pseAnioFk;
    }

    public void setPseAnioFk(Long pseAnioFk) {
        this.pseAnioFk = pseAnioFk;
    }
