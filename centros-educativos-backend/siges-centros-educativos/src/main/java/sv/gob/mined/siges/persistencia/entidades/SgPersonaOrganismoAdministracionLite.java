...
public class SgPersonaOrganismoAdministracionLite implements Serializable {
    ...
    @Transient
    private SgPersonaOrganismoAdministracionLite miembroReemplazar;
    ...
    public SgPersonaOrganismoAdministracionLite getMiembroReemplazar() {
        return miembroReemplazar;
    }

    public void setMiembroReemplazar(SgPersonaOrganismoAdministracionLite miembroReemplazar) {
    ...
    public String toString() {
        return "SgPersonaOrganismoAdministracionLite{" + "poaPk=" + poaPk + ", poaHabilitado=" + poaHabilitado + ", poaUltModFecha=" + poaUltModFecha + ", poaUltModUsuario=" + poaUltModUsuario + ", poaVersion=" + poaVersion + '}';
    }
