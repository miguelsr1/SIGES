...
public class SgConsultaPersonaCUNRNPNResponse implements Serializable {
    ...
    private Long numeroDocumentoMadre;
    private Integer idMunicipioNacimiento;
    private Integer idSexo;
    private Integer idAreaMadre;
    private Integer idTipoDocumentoMadre;
    private String cun;
       

    public SgConsultaPersonaCUNRNPNResponse() {
    }
    ...
    public Long getNumeroDocumentoMadre() {
        return numeroDocumentoMadre;
    }

    public void setNumeroDocumentoMadre(Long numeroDocumentoMadre) {
        this.numeroDocumentoMadre = numeroDocumentoMadre;
    }
    ...
    public Integer getIdAreaMadre() {
        return idAreaMadre;
    }

    public void setIdAreaMadre(Integer idAreaMadre) {
        this.idAreaMadre = idAreaMadre;
    }

    public Integer getIdTipoDocumentoMadre() {
        return idTipoDocumentoMadre;
    }

    public void setIdTipoDocumentoMadre(Integer idTipoDocumentoMadre) {
        this.idTipoDocumentoMadre = idTipoDocumentoMadre;
    }
