 ...
 */
@Entity
@Table(name = "sg_config_alerta_sobreedad", schema = Constantes.SCHEMA_ALERTAS)
@XmlRootElement
@EntityListeners(EntidadListener.class)
@JsonIdentityInfo(generator=ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class, property = "cnfPk", scope = SgConfigAlertaSobreedad.class)
public class SgConfigAlertaSobreedad implements Serializable {
    ...
    public SgConfigAlertaSobreedad() {
    }
