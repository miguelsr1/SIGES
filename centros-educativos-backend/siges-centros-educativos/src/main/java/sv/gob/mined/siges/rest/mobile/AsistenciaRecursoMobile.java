...
@RequestScoped
@Path("/m/v1/asistencias")
@Tag(name = "Asistencia M API V1")
...
public class AsistenciaRecursoMobile {

    private static final Logger LOGGER = Logger.getLogger(AsistenciaRecursoMobile.class.getName());
