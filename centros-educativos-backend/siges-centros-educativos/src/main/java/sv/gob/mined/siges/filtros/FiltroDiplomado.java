...
public class FiltroDiplomado implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 71 * hash + Objects.hashCode(this.codigoExacto);
        hash = 71 * hash + Objects.hashCode(this.nombre);
        hash = 71 * hash + Objects.hashCode(this.descripcion);
        hash = 71 * hash + Objects.hashCode(this.habilitado);
    ...
    public boolean equals(Object obj) {
        ...
        final FiltroDiplomado other = (FiltroDiplomado) obj;
