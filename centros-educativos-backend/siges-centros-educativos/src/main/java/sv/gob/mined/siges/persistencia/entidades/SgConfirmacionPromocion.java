 ...
 */
@Entity
@Table(name = "sg_confirmaciones_promociones", schema = Constantes.SCHEMA_CENTRO_EDUCATIVO)
@XmlRootElement
@EntityListeners(EntidadListener.class)
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class, property = "cprPk", scope = SgConfirmacionPromocion.class)
@Audited
public class SgConfirmacionPromocion implements Serializable {
    ...
    @JoinColumn(name = "cpr_cabezal_fk")
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @LazyToOne(LazyToOneOption.NO_PROXY)
    private SgCalificacionCE cprCabezalCalificacion;
    ...
    public SgConfirmacionPromocion() {
    }
    ...
    public SgCalificacionCE getCprCabezalCalificacion() {
        return cprCabezalCalificacion;
    }

    public void setCprCabezalCalificacion(SgCalificacionCE cprCabezalCalificacion) {
        this.cprCabezalCalificacion = cprCabezalCalificacion;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SgConfirmacionPromocion other = (SgConfirmacionPromocion) obj;
    ...
    public String toString() {
        return "SgConfirmacionPromocion{" + "cprPk=" + cprPk + '}';
    }
