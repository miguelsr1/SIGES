...
@Audited
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class, property = "pedPk", scope = SgProgramaEducativo.class)
public class SgProgramaEducativo implements Serializable {
    ...
    public SgProgramaEducativo(Long pedPk, Integer pedVersion) {
        this.pedPk = pedPk;
