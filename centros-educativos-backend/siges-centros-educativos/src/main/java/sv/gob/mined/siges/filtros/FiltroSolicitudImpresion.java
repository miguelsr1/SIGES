...
public class FiltroSolicitudImpresion implements Serializable {
    ...
    private Boolean noAnulados;
    private List<Long> solicitudesImpresionPk;
    private String simSedeCodigo;
    ...
    public Boolean getNoAnulados() {
        return noAnulados;
    }

    public void setNoAnulados(Boolean noAnulados) {
        this.noAnulados = noAnulados;
    }

    public List<Long> getSolicitudesImpresionPk() {
        return solicitudesImpresionPk;
    }

    public void setSolicitudesImpresionPk(List<Long> solicitudesImpresionPk) {
        this.solicitudesImpresionPk = solicitudesImpresionPk;
    }

    public String getSimSedeCodigo() {
        return simSedeCodigo;
    }

    public void setSimSedeCodigo(String simSedeCodigo) {
        this.simSedeCodigo = simSedeCodigo;
    }
