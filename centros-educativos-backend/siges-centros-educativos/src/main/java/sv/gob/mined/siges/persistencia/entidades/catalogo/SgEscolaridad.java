...
@Audited
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class, property = "escPk", scope = SgEscolaridad.class)
public class SgEscolaridad implements Serializable {
    ...
    @Size(max = 4)
    @Column(name = "esc_codigo", length = 4)
    @AtributoCodigo
