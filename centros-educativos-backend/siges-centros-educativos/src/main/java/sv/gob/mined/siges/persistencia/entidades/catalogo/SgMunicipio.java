...
@Audited
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class, property = "munPk", scope = SgMunicipio.class)
public class SgMunicipio implements Serializable {
    ...
    public SgMunicipio(Long munPk, Integer munVersion) {
        this.munPk = munPk;
