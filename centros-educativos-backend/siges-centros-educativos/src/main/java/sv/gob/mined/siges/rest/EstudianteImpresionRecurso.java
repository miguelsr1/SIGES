...
import sv.gob.mined.siges.negocio.servicios.EstudianteImpresionBean;
 ...
 */
@RequestScoped
@Path("/v1/estudiantesimpresion")
@Tag(name = "Estudiante Impresion API V1")
...
public class EstudianteImpresionRecurso {

    private static final Logger LOGGER = Logger.getLogger(EstudianteImpresionRecurso.class.getName());

    @Inject
    private EstudianteImpresionBean servicio;
     ...
     *
     * @param id Long
     * @return Response SgEstudianteImpresion
     */
    @GET
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Consumo satisfactorio.", content = @Content(
                ...
                schema = @Schema(implementation = SgEstudianteImpresion.class)))
        ,
    ...
    @Path("/{estudianteImpresionId:[1-9][0-9]*}")
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({ConstantesOperaciones.BUSCAR_SOLICITUD_IMPRESION})
    public Response obtenerPorId(@PathParam("estudianteImpresionId") Long id) {
        try {
            SgEstudianteImpresion sim = servicio.obtenerPorId(id);
            if (sim == null) {
     ...
     * @return Response Lista de SgEstudianteImpresion
     */
    @POST
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Consumo satisfactorio.", content = @Content(
                mediaType = MediaType.APPLICATION_JSON,
                schema = @Schema(implementation = SgEstudianteImpresion.class, type = SchemaType.ARRAY)))
        ,
        @APIResponse(responseCode = "400", description = "Solicitud con sintaxis incorrecta.")
        ,
        @APIResponse(responseCode = "500", description = "Error interno del servidor.")}
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({ConstantesOperaciones.BUSCAR_SOLICITUD_IMPRESION})
    public Response buscar(FiltroEstudianteImpresion filtro) {
        try {
