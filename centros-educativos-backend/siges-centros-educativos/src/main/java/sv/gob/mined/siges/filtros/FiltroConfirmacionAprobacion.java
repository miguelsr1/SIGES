...
public class FiltroConfirmacionAprobacion implements Serializable {
    
    private Long seccionFk;
    private Long componentePlanEstudioFk;
    private Long cprPk;
    ...
    public FiltroConfirmacionAprobacion() {
    }
    ...
    public Long getComponentePlanEstudioFk() {
        return componentePlanEstudioFk;
    }

    public void setComponentePlanEstudioFk(Long componentePlanEstudioFk) {
        this.componentePlanEstudioFk = componentePlanEstudioFk;
    }
