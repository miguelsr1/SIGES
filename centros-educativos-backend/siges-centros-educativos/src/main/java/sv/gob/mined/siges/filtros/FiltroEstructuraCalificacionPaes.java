...
public class FiltroEstructuraCalificacionPaes implements Serializable {
    ...
    private Long desdePk;
    private Long hastaPk;
    private Long estructuraPk;
    ...
    public Long getDesdePk() {
        return desdePk;
    }

    public void setDesdePk(Long desdePk) {
        this.desdePk = desdePk;
    }

    public Long getHastaPk() {
        return hastaPk;
    }

    public void setHastaPk(Long hastaPk) {
    ...
    public Long getEstructuraPk() {
        return estructuraPk;
    }

    public void setEstructuraPk(Long estructuraPk) {
        this.estructuraPk = estructuraPk;
    }
