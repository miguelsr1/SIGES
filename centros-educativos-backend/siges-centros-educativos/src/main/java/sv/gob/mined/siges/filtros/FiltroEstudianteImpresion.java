...
public class FiltroEstudianteImpresion implements Serializable {
    ...
    public Long getEimEstudiantePk() {
        return eimEstudiantePk;
    }

    public void setEimEstudiantePk(Long eimEstudiantePk) {
        this.eimEstudiantePk = eimEstudiantePk;
    }
