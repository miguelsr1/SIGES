...
public class FiltroAplicacionPlaza implements Serializable {
    ...
    private Boolean seleccionadoEnMatriz;
    private List<Long> aplPlazas;
    private String dui;
    private String nip;
    ...
    public Boolean getSeleccionadoEnMatriz() {
        return seleccionadoEnMatriz;
    }

    public void setSeleccionadoEnMatriz(Boolean seleccionadoEnMatriz) {
        this.seleccionadoEnMatriz = seleccionadoEnMatriz;
    }

    public List<Long> getAplPlazas() {
        return aplPlazas;
    }

    public void setAplPlazas(List<Long> aplPlazas) {
        this.aplPlazas = aplPlazas;
    }
