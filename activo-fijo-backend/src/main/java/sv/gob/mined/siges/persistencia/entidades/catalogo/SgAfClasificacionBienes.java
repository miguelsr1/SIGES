...
@Audited
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "cbiPk", resolver = JsonIdentityResolver.class, scope = SgAfClasificacionBienes.class)
