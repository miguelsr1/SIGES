...
public class SgDepartamento implements Serializable {
    ...
    @OneToMany(mappedBy = "dirDepartamento", fetch = FetchType.LAZY)
    @NotAudited
    private List<SgDireccion> depDirecciones;
    ...
    public List<SgDireccion> getDepDirecciones() {
        return depDirecciones;
    }

    public void setDepDirecciones(List<SgDireccion> depDirecciones) {
        this.depDirecciones = depDirecciones;
    }
    ...
    public String toString() {
        return "sv.gob.mined.siges.persistencia.entidades.SigesDepartamento{" + "depPk=" + depPk + '}';
    }
