...
@Audited
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "einPk", resolver = JsonIdentityResolver.class, scope = SgAfEstadosInventario.class)
