...
public class EmpleadosDAO extends HibernateJpaDAOImp<SgAfEmpleados, Long> implements Serializable {
    ...
    private List<CriteriaTO> generarCriteria(FiltroEmpleados filtro) {
        ...
        if (!StringUtils.isBlank(filtro.getPerDUINombreCompleto())) {
            ...
            MatchCriteriaTO criterioNombre = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.CONTAINS, "empPersonaFk.perNombreBusqueda", SofisStringUtils.normalizarParaBusqueda(filtro.getPerDUINombreCompleto()));
            nombreDUIOR.add(criterioNombre);
            
            MatchCriteriaTO criterioDUI = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.CONTAINS, "empPersonaFk.perDui", SofisStringUtils.normalizarParaBusqueda(filtro.getPerDUINombreCompleto()));
