...
public class SgAfCategoriaBienes implements Serializable {
    ...
    @OneToMany(mappedBy = "scaCategoriaFk")
    ...
    public void setSgAfSeccionesCategoriaList(List<SgAfSeccionCategoria> sgAfSeccionesCategoriaList) {
        if (sgAfSeccionesCategoriaList == null) {
            return;
        }
        if(this.sgAfSeccionesCategoriaList != null) {
            this.sgAfSeccionesCategoriaList.clear();
            this.sgAfSeccionesCategoriaList.addAll(sgAfSeccionesCategoriaList); 
        } 
    }
