...
public class SgDireccion implements Serializable {
    ...
    @OneToMany(mappedBy = "sedDireccion", fetch = FetchType.LAZY)
    @NotAudited
    private List<SgSede> dirSedes;
    ...
    public List<SgSede> getDirSedes() {
        return dirSedes;
    }

    public void setDirSedes(List<SgSede> dirSedes) {
        this.dirSedes = dirSedes;
    }
