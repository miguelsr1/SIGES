...
@Audited
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "edePk", resolver = JsonIdentityResolver.class, scope = SgAfEstadosDescargo.class)
