...
public class PlanesEstudioRestClient implements Serializable {
    ...
    public List<SgPlanEstudio> buscar(FiltroPlanEstudio filtro, String userToken) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
        if (filtro == null) {
        ...
        SgPlanEstudio[] planesEstudio = RestClient.invokePost(webTarget, filtro, SgPlanEstudio[].class, userToken);
