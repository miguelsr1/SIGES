...
public class GradoRestClient implements Serializable {
    ...
    public List<SgGrado> buscar(@CacheKey FiltroGrado filtro, String userToken) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
