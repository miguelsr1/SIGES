...
public class ModalidadRestClient implements Serializable {
    ...
    public List<SgModalidad> buscar(@CacheKey FiltroModalidad filtro, String userToken) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
