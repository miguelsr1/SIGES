...
public class OpcionRestClient implements Serializable {
    ...
    public List<SgOpcion> buscar(@CacheKey FiltroOpciones filtro, String userToken) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
