...
public class RelModEdModAtenRestClient implements Serializable {
    ...
    public List<SgRelModEdModAten> buscar(@CacheKey FiltroRelModEdModAten filtro, String userToken) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
