...
public class NivelRestClient implements Serializable {
    ...
    public List<SgNivel> buscar(@CacheKey FiltroNivel filtro, String userToken) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
