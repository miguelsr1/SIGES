...
public class OrganizacionCurricularRestClient implements Serializable {
    ...
    public List<SgOrganizacionCurricular> buscar(@CacheKey FiltroCodiguera filtro, String userToken) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
        ...
        SgOrganizacionCurricular[] organizacionesCurricular = RestClient.invokePost(webTarget, filtro, SgOrganizacionCurricular[].class, userToken);
