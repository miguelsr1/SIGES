...
public class InfinispanConfig {
    ...
    public void init(@Observes @Initialized(ApplicationScoped.class) Object init) throws Exception {
        ...
        //Catalogo
        manager.createCache(Constantes.USUARIO_ROL_CACHE, mutableConfiguration);
        ...
        manager.createCache(Constantes.RECURSO_EDUCATIVO_CACHE, mutableConfiguration);
        manager.createCache(Constantes.MOTIVO_LICENCIA_CACHE, mutableConfiguration);
        manager.createCache(Constantes.MOTIVO_PERMUTA_CACHE, mutableConfiguration);
        manager.createCache(Constantes.TIPO_CALENDARIO_CACHE, mutableConfiguration);
        manager.createCache(Constantes.USUARIO_OPERACIONES_CACHE, mutableConfiguration);
