...
public class StaticRestClient implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(StaticRestClient.class.getName());

    public StaticRestClient() {
    }
