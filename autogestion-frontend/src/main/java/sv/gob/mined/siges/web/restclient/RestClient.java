...
public class RestClient implements Serializable {
    ...
    public <S, T> T invokeGetFile(WebTarget webTarget, S request, Class<T> responseType) throws HttpClientException, HttpServerException, HttpServerUnavailableException, BusinessException {
        LOGGER.log(Level.INFO, "Invocando post: " + webTarget.getUri().toString());
        Entity<S> requestEntity = Entity.entity(request, MediaType.APPLICATION_JSON_TYPE);
