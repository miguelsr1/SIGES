...
public class SgTransferenciaDireccionDep implements Serializable {
    ...
    private BigDecimal tddMontoRequerido;
    ...
    public BigDecimal getTddMontoRequerido() {
        return tddMontoRequerido;
    }

    public void setTddMontoRequerido(BigDecimal tddMontoRequerido) {
        this.tddMontoRequerido = tddMontoRequerido;
    }
