...
public class SsTransferencia implements Serializable {
    ...
    public String toString() {
        return "SsTransferencia{" + "traId=" + traId + ", traAnioFiscal=" + traAnioFiscal + ", traSubcomponente=" + traSubcomponente + ", traLineaPresupuestaria=" + traLineaPresupuestaria + ", traPorcentaje=" + traPorcentaje + ", traImporteFijoCentro=" + traImporteFijoCentro + ", traRemanente=" + traRemanente + ", traUltModFecha=" + traUltModFecha + ", traUltModUsuario=" + traUltModUsuario + '}';
    }
