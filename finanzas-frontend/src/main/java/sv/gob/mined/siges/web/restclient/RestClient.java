...
//        } catch (Exception ex){}
    ...
    public static <T> T invokeGetH(WebTarget webTarget, Class<T> responseType, String userToken) throws HttpClientException, HttpServerException, HttpServerUnavailableException, BusinessException {
