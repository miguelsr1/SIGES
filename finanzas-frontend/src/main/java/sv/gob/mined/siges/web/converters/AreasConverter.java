...
public class AreasConverter implements Converter {
    ...
    @Inject
    private AreaInversionRestClient restClient;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object o) {
        ...
        if (o == null) {
            return null;
        } else if (o instanceof SgAreaInversion) {
            return String.valueOf(((SgAreaInversion) o).getAdiPk());
        } else if (o instanceof String) {
            if (StringUtils.isBlank((String) o)) {
                return null;
            }
        }
        throw new ConverterException(new FacesMessage(o + " is not a valid Area"));
    }
}
