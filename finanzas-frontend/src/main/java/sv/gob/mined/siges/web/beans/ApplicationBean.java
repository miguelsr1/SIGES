...
@ApplicationScoped
/**
 * Gestión de elementos generales de alcance application.
 */
public class ApplicationBean implements Serializable {
    ...
    @Inject
    @ConfigProperty(name = "service.centros-educativos-front.baseUrl")
    private String centrosEducativosUrl;
    ...
    private String maskNit = "9999-999999-999-9";

    /**
     * Crea una nueva clase del objeto
     */
    ...
    public SelectItem[] getMinedValues() {
        return new SelectItem[]{
            new SelectItem(Boolean.TRUE, "MINED"),
            new SelectItem(Boolean.FALSE, "No MINED")
        };
    }
    ...
    public String getCentrosEducativosUrl() {
        return centrosEducativosUrl;
    }

    public void setCentrosEducativosUrl(String centrosEducativosUrl) {
        this.centrosEducativosUrl = centrosEducativosUrl;
    }
