...
@Named
@ApplicationScoped
public class TipoCuentaBancariaConverter implements Converter {

    
    @Inject
    private TipoCuentasBancariaRestClient restClient;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object o) {
        if (o == null) {
            return null;
        } else if (o instanceof SgTipoCuentaBancaria) {
            return String.valueOf(((SgTipoCuentaBancaria) o).getTcbPk());
