...
public class ControlAcceso implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            //Esto de acepta terminos capaz hay q sacarlo.Me lo anoto para verlo
//            if (BooleanUtils.isNotTrue(sessionBean.getEntidadUsuario().getUsuAceptaTerminos()) || !sessionBean.getOperaciones().contains(ConstantesOperaciones.TIENE_ACCESO_FINANZAS)) {
//
...
//            }
    ...
    /**
     * Inicialización del filtro de configuración
     */
