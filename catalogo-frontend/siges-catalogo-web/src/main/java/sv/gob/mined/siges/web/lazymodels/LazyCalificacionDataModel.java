 ...
 */
public class LazyCalificacionDataModel extends LazyDataModel<SgCalificacion> implements Serializable {
    ...
    @Override
    public SgCalificacion getRowData(String rowKey) {
        try {
    ...
    @Override
    public Object getRowKey(SgCalificacion c) {
        return c.getCalPk();
    }

    @Override
    public List<SgCalificacion> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        try {
