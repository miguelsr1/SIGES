...
public class SgAfClasificacionBienes implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 79 * hash + Objects.hashCode(this.cbiPk);
        hash = 79 * hash + Objects.hashCode(this.cbiCodigo);
        hash = 79 * hash + Objects.hashCode(this.cbiNombre);
        hash = 79 * hash + Objects.hashCode(this.cbiHabilitado);
        hash = 79 * hash + Objects.hashCode(this.cbiUltModFecha);
        hash = 79 * hash + Objects.hashCode(this.cbiUltModUsuario);
        hash = 79 * hash + Objects.hashCode(this.cbiVersion);
        return hash;
    }
