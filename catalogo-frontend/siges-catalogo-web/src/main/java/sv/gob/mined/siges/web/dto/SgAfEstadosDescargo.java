...
public class SgAfEstadosDescargo implements Serializable {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 29 * hash + Objects.hashCode(this.edePk);
        hash = 29 * hash + Objects.hashCode(this.edeCodigo);
        hash = 29 * hash + Objects.hashCode(this.edeNombre);
        hash = 29 * hash + Objects.hashCode(this.edeNombreBusqueda);
        hash = 29 * hash + Objects.hashCode(this.edeHabilitado);
        hash = 29 * hash + Objects.hashCode(this.edeUltModFecha);
        hash = 29 * hash + Objects.hashCode(this.edeUltModUsuario);
        hash = 29 * hash + Objects.hashCode(this.edeVersion);
        return hash;
    }
