 ...
 */
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "smoPk", scope = SgSubModalidad.class) 
...
public class SgSubModalidad implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final SgSubModalidad other = (SgSubModalidad) obj;
