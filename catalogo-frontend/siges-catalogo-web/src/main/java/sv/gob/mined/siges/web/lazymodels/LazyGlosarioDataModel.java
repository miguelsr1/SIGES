...
import sv.gob.mined.siges.web.rest.GlosarioRestClient;
...
public class LazyGlosarioDataModel extends LazyDataModel<SgGlosario> implements Serializable {
    ...
    private GlosarioRestClient restClient;
    private FiltroCodiguera filtro;

    public LazyGlosarioDataModel(GlosarioRestClient restClient, FiltroCodiguera filtro, Long rowCount, Integer pageSize) {
