...
public class EtiquetaBean implements Serializable {
    ...
    private SgEtiqueta entidadEnEdicion = new SgEtiqueta();
    private List<SgEtiqueta> historialEtiqueta = new ArrayList();
    ...
    public void agregar() {
        ...
        limpiarCombos();
        entidadEnEdicion = new SgEtiqueta();
    }

    public void actualizar(SgEtiqueta var) {
        JSFUtils.limpiarMensajesError();
        limpiarCombos();
        entidadEnEdicion = (SgEtiqueta) SerializationUtils.clone(var);
    }
    ...
    public void historial(Long id) {
        try {
            historialEtiqueta = restClient.obtenerHistorialPorId(id);
        } catch (Exception ex) {
            LOGGER.log(Level.SEVERE, ex.getMessage(), ex);
            JSFUtils.agregarError(ConstantesComponentesId.ID_MSG_TEMPLATE, Mensajes.obtenerMensaje(Mensajes.ERROR_GENERAL), "");
        }
    ...
    public SgEtiqueta getEntidadEnEdicion() {
        return entidadEnEdicion;
    }

    public void setEntidadEnEdicion(SgEtiqueta entidadEnEdicion) {
        this.entidadEnEdicion = entidadEnEdicion;
    }

    public List<SgEtiqueta> getHistorialEtiqueta() {
        return historialEtiqueta;
    }

    public void setHistorialEtiqueta(List<SgEtiqueta> historialEtiqueta) {
        this.historialEtiqueta = historialEtiqueta;
    }
    ...
    public void setTiposCalendarioLazyModel(LazyEtiquetaDataModel etiquetaLazyModel) {
