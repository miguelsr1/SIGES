...
public class FiltroFuenteFinanciamientoAF {
    private String codigo;
    private String codigoExacto;
    private String nombre;
    private String descripcion;
    private Boolean habilitado;
    private EnumFuenteFinanciamiento ambito;
    ...
    public EnumFuenteFinanciamiento getAmbito() {
        return ambito;
    }

    public void setAmbito(EnumFuenteFinanciamiento ambito) {
        this.ambito = ambito;
    }
