...
@Named
@ApplicationScoped
public class EscalaCalificacionConverter implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object o) {
        if (o == null) {
            return null;
        } else if (o instanceof SgEscalaCalificacion) {
            return String.valueOf(((SgEscalaCalificacion) o).getEcaPk());
