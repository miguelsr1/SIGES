...
import sv.gob.mined.siges.web.lazymodels.LazyConfiguracionDataModel;
...
public class ConfiguracionBean implements Serializable {
    ...
    private SgConfiguracion entidadEnEdicion = new SgConfiguracion();
    private List<SgConfiguracion> historialConfiguracion = new ArrayList();
    ...
    public void agregar() {
        ...
        limpiarCombos();
        entidadEnEdicion = new SgConfiguracion();
    }

    public void actualizar(SgConfiguracion var) {
        JSFUtils.limpiarMensajesError();
        limpiarCombos();
        entidadEnEdicion = (SgConfiguracion) SerializationUtils.clone(var);
    }
    ...
    public void eliminar() {
        try {
            restClient.eliminar(entidadEnEdicion.getConPk());
    ...
    public void historial(Long id) {
        try {
            historialConfiguracion = restClient.obtenerHistorialPorId(id);
        } catch (Exception ex) {
            LOGGER.log(Level.SEVERE, ex.getMessage(), ex);
            JSFUtils.agregarError(ConstantesComponentesId.ID_MSG_TEMPLATE, Mensajes.obtenerMensaje(Mensajes.ERROR_GENERAL), "");
        }
    ...
    public List<SgConfiguracion> getHistorialConfiguracion() {
        return historialConfiguracion;
    }

    public void setHistorialConfiguracion(List<SgConfiguracion> historialConfiguracion) {
