 ...
 */
public class LazyEtiquetaDataModel extends LazyDataModel<SgEtiqueta> implements Serializable {
    ...
    @Override
    public SgEtiqueta getRowData(String rowKey) {
        try {
    ...
    @Override
    public Object getRowKey(SgEtiqueta c) {
        return c.getEtiPk();
    }

    @Override
    public List<SgEtiqueta> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        try {
