...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "mrePk", scope = SgMotivoRetiro.class)
public class SgMotivoRetiro implements Serializable {
    ...
    public SgMotivoRetiro() {
        ...
        this.mreDefinitivo = Boolean.FALSE;
        this.mreTraslado = Boolean.FALSE;
        this.mreCambioSecc = Boolean.FALSE;
    }
