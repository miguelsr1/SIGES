...
public class SgModalidadAtencion implements Serializable {
    ...
    private List<SgSubModalidad> matSubmodalidades;
    ...
    public List<SgSubModalidad> getMatSubmodalidades() {
        return matSubmodalidades;
    }

    public void setMatSubmodalidades(List<SgSubModalidad> matSubmodalidades) {
