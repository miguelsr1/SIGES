 ...
 */
@Entity
@Table(name = "sg_motivos_cierre_sede", uniqueConstraints = {
    @UniqueConstraint(name = "mcs_codigo_uk", columnNames = {"mcs_codigo"})
    ,
    @UniqueConstraint(name = "mcs_nombre_uk", columnNames = {"mcs_nombre"})}, schema = Constantes.SCHEMA_CATALOGO)
@XmlRootElement
...
public class SgMotivoCierreSede implements Serializable {
    ...
    @PreUpdate
    public void preSave() {
        this.mcsNombreBusqueda = SofisStringUtils.normalizarParaBusqueda(this.mcsNombre);
    }
