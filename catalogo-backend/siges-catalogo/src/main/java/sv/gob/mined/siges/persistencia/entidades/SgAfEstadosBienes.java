...
@Audited
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "ebiPk", scope = SgAfEstadosBienes.class)
public class SgAfEstadosBienes implements Serializable {
    ...
    @Size(max = 15)
    @Column(name = "ebi_codigo", length = 15)
    @AtributoCodigo
    ...
    @Column(name = "ebi_aplica_para", nullable = true)
    ...
    public int hashCode() {
        int hash = 7;
        hash = 59 * hash + Objects.hashCode(this.ebiPk);
        return hash;
    }
