...
public class ModalidadAtencionValidacionNegocio {
     ...
     */
    public static boolean validar(SgModalidadAtencion mat) throws BusinessException {
        ...
        if (mat==null) {
            ...
            } else if (mat.getMatCodigo().length() > 10){
                ge.addError("matCodigo", Errores.ERROR_LARGO_CODIGO_10);
            }
     ...
     * @return Boolean
     */
    public static boolean compararParaGrabar(SgModalidadAtencion c1, SgModalidadAtencion c2) {
        boolean respuesta = true;
        if (c1!=null) {
            if (c2!=null) {
