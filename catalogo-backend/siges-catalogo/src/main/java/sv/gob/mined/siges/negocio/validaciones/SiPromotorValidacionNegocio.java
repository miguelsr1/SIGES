 ...
 */
public class SiPromotorValidacionNegocio  {
     ...
     */
    public static boolean validar(SgSiPromotor pro) throws BusinessException {
        ...
        if (pro==null) {
            ...
            } else if (pro.getProCodigo().length() > 45){
                ge.addError("proCodigo",Errores.ERROR_LARGO_CODIGO_45);
            }
     ...
     *
     * @param c1 SgSiPromotor
     * @param c2 SgSiPromotor
     * @return Boolean
     */
    public static boolean compararParaGrabar(SgSiPromotor c1, SgSiPromotor c2) {
        boolean respuesta = true;
        if (c1!=null) {
            if (c2!=null) {
