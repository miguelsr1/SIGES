 ...
 */
@Entity
@Table(name = "sg_tipos_requerimientos_infra", uniqueConstraints = {
    @UniqueConstraint(name = "trin_codigo_uk", columnNames = {"tri_codigo"})
    ,
    @UniqueConstraint(name = "trin_nombre_uk", columnNames = {"tri_nombre"})}, schema = Constantes.SCHEMA_CATALOGO)
@XmlRootElement
...
public class SgTipoRequerimientoInfra implements Serializable {
    ...
    public String toString() {
        return "SgTipoRequerimientoInfra{" + "triPk=" + triPk + ", triCodigo=" + triCodigo + ", triNombre=" + triNombre + ", triNombreBusqueda=" + triNombreBusqueda + ", triHabilitado=" + triHabilitado + ", triUltModFecha=" + triUltModFecha + ", triUltModUsuario=" + triUltModUsuario + ", triVersion=" + triVersion + '}';
    }
