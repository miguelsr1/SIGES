 ...
 */
public class InfTipoDocumentoValidacionNegocio  {
     ...
     */
    public static boolean validar(SgInfTipoDocumento tid) throws BusinessException {
     ...
     *
     * @param c1 SgInfTipoDocumento
     * @param c2 SgInfTipoDocumento
     * @return Boolean
     */
    public static boolean compararParaGrabar(SgInfTipoDocumento c1, SgInfTipoDocumento c2) {
        boolean respuesta = true;
        if (c1!=null) {
            if (c2!=null) {
