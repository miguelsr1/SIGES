...
public class SgAfUnidadesAdministrativas implements Serializable {
    ...
    @Size(max = 255)
    @Column(name = "uad_direccion", length = 255)
    ...
    @Size(max = 60)
    @Column(name = "uad_cargo_responsable",  length = 60)
    private String uadCargoResponsable;
    ...
    public String getUadCargoResponsable() {
        return uadCargoResponsable;
    }

    public void setUadCargoResponsable(String uadCargoResponsable) {
        this.uadCargoResponsable = uadCargoResponsable;
    }
