...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "dtiPk", scope = SgDefinicionTitulo.class)
@Audited
public class SgDefinicionTitulo implements Serializable {
    ...
    @JoinColumn(name = "dti_plantilla_fk", referencedColumnName = "pla_pk")
    @ManyToOne
    ...
    private Boolean dtiEsTipoReposicion;
    ...
    public Boolean getDtiEsTipoReposicion() {
        return dtiEsTipoReposicion;
    }

    public void setDtiEsTipoReposicion(Boolean dtiEsTipoReposicion) {
