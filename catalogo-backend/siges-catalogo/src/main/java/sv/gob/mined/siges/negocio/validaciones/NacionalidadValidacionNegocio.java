 ...
 */
public class NacionalidadValidacionNegocio  {
     ...
     */
    public static boolean validar(SgNacionalidad nac) throws BusinessException {
     ...
     *
     * @param c1 SgNacionalidad
     * @param c2 SgNacionalidad
     * @return Boolean
     */
    public static boolean compararParaGrabar(SgNacionalidad c1, SgNacionalidad c2) {
        boolean respuesta = true;
        if (c1!=null) {
            if (c2!=null) {
