...
@Audited
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "tssPk", scope = SgTipoServicioSanitario.class)
public class SgTipoServicioSanitario implements Serializable {
    ...
    @Column(name = "tss_aplica_estudiante")
    private Boolean tssAplicaEstudiante;
    
    @Column(name = "tss_aplica_inmueble")
    private Boolean tssAplicaInmueble;
    
    @Column(name = "tss_aplica_edificio")
