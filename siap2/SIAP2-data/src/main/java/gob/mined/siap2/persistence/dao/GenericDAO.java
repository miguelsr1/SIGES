 ...
 *
 */
package gob.mined.siap2.persistence.dao;
...
public interface GenericDAO<T, ID extends Serializable> {
     ...
     * Retorna todas las entidades de tipo tClass
     * @param tClass la clase de la entidades a retornar
     * @param campoOrder Indica el campo por el que se quiere el orden.
     * @return
     * @throws DAOGeneralException
     */
    ...
    /**
     * Retorna el objeto de la entidad según el criteria, retorna el objeto completo de la entidad
     ...
     * @param startPosition desde
     * @param maxResult hasta
     * @param propertyNames las propiedades que se quieren retornar de la entidad
     * @return
     * @throws DAOGeneralException
     */
    ...
    /**
     * Retorna una colección de entityReference donde en el propertyMap posee las propiedades de propertyName
     * @param entityClass la clase de la entidad
     * @param criteria el criterio
     * @param orderBy la ordenación del resultado
     * @param ascending si es ascendente o no cada propiedad a ordenar
