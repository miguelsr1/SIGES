 ...
 */
public class ActionTO extends ComponentTO {
    ...
    //el formulario asociado a la acción, en caso de edit o new es el formularios
    ...
    //NO en USO, implica si una entidad de una colección de la entidad principal se
    ...
    //al user defined igualmente se desea ejecutar la validación definida en el modelo
    ...
    //en otro caso si estan presentes antes de ejecutar la acción se invocan estos metodos
    //en caso de user_defined debe de devolver el case de navegación
    private String bean;
    private String beanMethodName;
    //implica si antes de ejecutar la acción asociada se quiere perdir confirmación, si tiene un valor
    //cargado este String es la clave para mostrar en el mensaje javascript de confirmación
    private String confirmActionKey;
    //el metodo del bean a ejecutarse luego de que se ejecuta la acción
    ...
    //este atributo indica la operación habilitada necesaria en el rol del usuario para ejecutar la acción
