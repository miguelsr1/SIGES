 ...
 */
public class ColumnTO extends BindingComponentTO {
    ...
    /**
     * En caso que la columna sea un date entonces se setea este elemento que define como se despliega el date en la tabla
     */
    InputDateTO componentDate;
    /**
     * En caso de ser una tabla editable, para cada columna se muestra un componente
     */
