...
@LocalBean
@Stateless(name = "generacionTechosDesdeArchivoBean")
public class GeneracionTechosDesdeArchivoBean {
    private static final Logger logger = Logger.getLogger(GeneracionTechosDesdeArchivoBean.class.getName());
    
    @Inject
    private ProcesamientoTechosDesdeArchivoAsincBean procesamientoTechosDesdeArchivoAsincBean;
    ...
    public void crearDesdeArchivo(TopePresupuestalArchivoTo archivo) {
        try {
            ...
            if(relPresupuestoAnio.getProcesoEnCurso() == null || !relPresupuestoAnio.getProcesoEnCurso()) {
                 procesamientoTechosDesdeArchivoAsincBean.crearDesdeArchivo(archivo);
            } else {
