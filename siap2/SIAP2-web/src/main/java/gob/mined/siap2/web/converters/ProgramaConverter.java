 ...
 */
@Named
public class ProgramaConverter implements Converter, Serializable{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
            Programa dt = (Programa) emd.getEntityById(Programa.class.getCanonicalName(), Integer.valueOf(value));
            return dt;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object o) {
        if (o instanceof Programa) {
            return String.valueOf(((Programa) o).getId());
        } else if (o == null) {
            return null;
