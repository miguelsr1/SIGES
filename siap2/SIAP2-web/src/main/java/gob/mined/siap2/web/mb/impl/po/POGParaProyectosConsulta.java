 ...
 * que se utiliza para realizar la consulta de los POG de proyecto.
 * 
 *
 * @author sofis
 */
@ViewScoped
@Named(value = "pogProyectosConsulta")
public class POGParaProyectosConsulta implements Serializable{
    ...
    /**
     * Crea una nueva instancia de ProgramaInstitucionalMB
     */
    public POGParaProyectosConsulta() {
    }
    ...
    public void filterTable() {
        try {
            ...
            //que el proyecto requeria pog
            MatchCriteriaTO criterioPog = CriteriaTOUtils.createMatchCriteriaTO( MatchCriteriaTO.types.EQUALS, "tienePOG", true);
            criterios.add(criterioPog);
            
            //se encuentre en estado bloqueado
            MatchCriteriaTO criterioEstado = CriteriaTOUtils.createMatchCriteriaTO( MatchCriteriaTO.types.EQUALS, "estado", EstadoProyecto.BLOQUEADO);
            criterios.add(criterioEstado);
            
            
            /// que el pog no ya este creado
            MatchCriteriaTO pogCreado = CriteriaTOUtils.createMatchCriteriaTO( MatchCriteriaTO.types.NOT_NULL, "pog", 1);
            criterios.add(pogCreado);
            ...
            String[] propiedades = {"id",
                ...
                "nombre", 
                "tipoProyecto", 
                "programaPresupuestario.nombre", 
                "programaInstitucional.nombre",
                "inicio",
                "fin",
                "codigoSIIP",
                "tipoEstructuraComponente", 
                "tipoEstructuraMacroactividad"};
