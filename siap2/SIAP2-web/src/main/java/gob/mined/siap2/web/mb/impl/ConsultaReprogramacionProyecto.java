 ...
 */
@ViewScoped
@Named(value = "consultaReprogramacionProyecto")
public class ConsultaReprogramacionProyecto implements Serializable {
    ...
    public void filterTable() {
        try {
            ...
            MatchCriteriaTO criterioTipo = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.EQUALS, "tipoReprogramacion", TipoReprogramacion.PROYECTO);
