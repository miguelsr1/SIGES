 ...
 */
@ViewScoped
@Named(value = "consultaReprogramacionAccionCentral")
public class ConsultaReprogramacionAccionCentral implements Serializable {
    ...
    public void filterTable() {
        try {
            ...
            MatchCriteriaTO criterioTipo = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.EQUALS, "tipoReprogramacion", TipoReprogramacion.ACCION_CENTRAL);
