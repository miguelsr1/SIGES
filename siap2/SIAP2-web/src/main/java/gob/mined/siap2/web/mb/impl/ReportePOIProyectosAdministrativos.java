 ...
 * que realiza el reporte POI para proyectos administrativos.
 * 
 *
 * @author sofis
 */
@ViewScoped
@Named(value = "reportePOIProyectosAdministrativos")
public class ReportePOIProyectosAdministrativos implements Serializable {
    ...
    public void filterTable() {
        try {
            ...
            registros = valoresDeIndicadores.obtenerInfoReportePOIProyectosAdministrativosProgPresupuestario(new Integer(planificacionEstrategicaId), new Integer(anioFiscalId));
    ...
    public void generarPDF() {
        try {
            ...
            byte[] bytespdf = reporteDelegate.generarReportePOI(registros, planificacion, anio,"P");
