...
public class SofisCombo {
    ...
    private HashMap<Integer, Object> objetos = new HashMap<Integer, Object>();
    private HashMap<Integer, Object> objetosComunes = new HashMap<Integer, Object>();
    private HashMap<Integer, Object> objetosNoComunes = new HashMap<Integer, Object>();
    ...
    // </editor-fold>
    /**
     * Devuelve todos los objetos que tiene el combo
     *
     * @return
     */
    ...
    public void addComun(Object objeto) {
        ...
        if (propertyName == null) {
            ...
            Object objectName = getPropertyValue(objeto, propertyName);
            if (objectName != null) {
