...
public class LazyLoadingDetalleTopePresupuestal extends LazyDataModel<TopeDetalleMatriculas>{
    
    IDataProvider provider;
    private static final Logger logger = Logger.getLogger(ConstantesEstandares.LOGGER);

    public LazyLoadingDetalleTopePresupuestal(IDataProvider provider) {
    ...
    @Override
    public List<TopeDetalleMatriculas> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        try {
    ...
    @Override
    public Object getRowKey(TopeDetalleMatriculas tope) {
        return tope != null ? tope.getId() : null;
    }

    @Override
    public TopeDetalleMatriculas getRowData(String rowKey) {
        EntityManagementDelegate emd = new EntityManagementDelegate();
        try {
            return (TopeDetalleMatriculas) emd.getEntityById(TopeDetalleMatriculas.class.getName(), Integer.valueOf(rowKey));
