 ...
 * página que trabaja con la consulta de POAS de acciones centrales
 * 
 * @author Sofis Solutions
 */
@ViewScoped
@Named(value = "poaAccionCentralConsulta")
public class POAAccionCentralConsulta implements Serializable {
    ...
    private List<UnidadTecnica> lista;
        ...
        try {
            ...
            if (userInfo.getUnidadTecnicas().isEmpty()) {
                ...
                for (UnidadTecnica ut : userInfo.getUnidadTecnicas()) {
                    MatchCriteriaTO criterio = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.EQUALS, "montosUT.unidadTecnica.id", ut.getId());
            ...
            String className = AccionCentral.class.getName();
