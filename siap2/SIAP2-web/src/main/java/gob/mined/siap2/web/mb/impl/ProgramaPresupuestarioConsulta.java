 ...
 */
@ViewScoped
@Named(value = "programaPresupuestarioC")
public class ProgramaPresupuestarioConsulta implements Serializable {
    ...
    private String programaInstitucionalId =  null;

    /**
     * Creates a new instance of ProgramaInstitucionalMB
     */
    public ProgramaPresupuestarioConsulta() {
    }
    ...
    public void filterTable() {
        try {
            ...
            if (!incluirSubprogramas) {
                MatchCriteriaTO criterio = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.NULL, "programaPresupuestario", 0);
                criterios.add(criterio);
            }
            
            
            if (!TextUtils.isEmpty(programaInstitucionalId)){
                MatchCriteriaTO criterio = CriteriaTOUtils.createMatchCriteriaTO(MatchCriteriaTO.types.EQUALS, "programasInstitucionales.id", Integer.parseInt(programaInstitucionalId));
                criterios.add(criterio);                
            }
            ...
            String className = ProgramaPresupuestario.class.getName();
    ...
    public void eliminar(Integer idToEliminar) {
        try {
            progDelegate.eleiminarProgramaPresupuestario(Integer.valueOf(idToEliminar));
    ...
    public String getProgramaInstitucionalId() {
        return programaInstitucionalId;
    }

    public void setProgramaInstitucionalId(String programaInstitucionalId) {
