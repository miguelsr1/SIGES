 ...
 */
@ViewScoped
@Named(value = "consultaEstadoInsumosconsultaEstadoInsumos")
public class ConsultaEstadoInsumos implements Serializable {
    ...
    /**
     * Calcula la diferencia entre el monto estimado y el certificado de un
     * insumo
     *
     * @param insumo
     * @return
    ...
    /**
     * Calcula la suma de los montos del insumo en las actas de recepción
     * aprobadas
     *
     * @return
     */
