...
public class ConvenioConverter implements Converter, Serializable{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
            Convenio dt = (Convenio) emd.getEntityById(Convenio.class.getCanonicalName(), Integer.valueOf(value));
            return dt;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object o) {
        if (o == null) {
            return null;
        } else if (o instanceof Convenio) {
            return String.valueOf(((Convenio) o).getId());
        } else if (o instanceof String) {
            if (TextUtils.isEmpty((String) o)){
                return null;
            }
        }
        throw new ConverterException(new FacesMessage(o + " is not a valid Convenio"));
    }
