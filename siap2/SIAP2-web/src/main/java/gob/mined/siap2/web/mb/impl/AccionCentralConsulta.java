...
/**
 * Esta clase implementa los métodos de consulta de acciones centrales
 *
 * @author Sofis Solutions
 */
@ViewScoped
@Named(value = "accionCentralConsulta")
public class AccionCentralConsulta implements Serializable {
    ...
    /**
     * Este método permite descargar el reporte de acción central.
     */
    public void descargarReporte() {
        try {
            byte[] bytespdf = reporteDelegate.generarReporteGralAccionCentral();
