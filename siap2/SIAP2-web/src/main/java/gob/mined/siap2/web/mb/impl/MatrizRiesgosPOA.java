 ...
 */
@ViewScoped
@Named(value = "matrizRiesgosPOA")
public class MatrizRiesgosPOA implements Serializable {
    ...
    private List<RiesgoTOPOA> listaRiesgos = new ArrayList();
    ...
    public void generarPDF() {
        try {
            byte[] bytespdf = reporteDelegate.generarReporteMatrizRiesgoPOA(listaRiesgos);
    ...
    public List<RiesgoTOPOA> getListaRiesgos() {
        return listaRiesgos;
    }

    public void setListaRiesgos(List<RiesgoTOPOA> listaRiesgos) {
