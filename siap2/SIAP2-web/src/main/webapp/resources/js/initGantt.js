...
$(function () {
    ...
    //workSpace.css({width:$(window).width() - 310});
...
//  $(".ganttButtonBar div").addClass('buttons');
    ...
    $(window).resize(function () {
        ...
        workSpace.css({width: $(window).width() - 300});
...
//  if (!ret || !ret.tasks || ret.tasks.length == 0){
    console.log("################### LOAD GANT INIT BEGIN ######################")
    var retElem = $("#ta");
    console.log(retElem)
    if (retElem === null)
        return;
    ...
    ret = JSON.parse(retElem.val());
    //
    //lo pone relativo a la fecha de hoy
    //actualiza data
...
//  }
    ge.loadProject(ret);
    ge.checkpoint(); //empty the undo stack
    console.log("################### LOAD GANT INIT END ######################")
}
...
//  } else {
    var strGantt = JSON.stringify(prj);
    $("#ta").val(strGantt);
//  }
}
