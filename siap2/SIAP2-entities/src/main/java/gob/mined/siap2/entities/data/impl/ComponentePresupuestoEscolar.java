...
@Cacheable(false)
public class ComponentePresupuestoEscolar implements Serializable {
    ...
    private CategoriaPresupuestoEscolar categoriaPresupuestoEscolar;
    ...
    @JoinTable(
            ...
            name = "ss_rel_componentepresupescolar_areainv",
            joinColumns = { @JoinColumn(name = "ges_id")},
            inverseJoinColumns = {@JoinColumn(name = "ai_id")}
    )
    private List<AreasInversion> subareasInversion;
    
    
    @OneToMany
    @JoinTable(
            schema = Constantes.SCHEMA_SIAP2,
            name = "ss_rel_ges_pres_es_tipo_organismo_escolar",
            joinColumns = { @JoinColumn(name = "ges_id")},
            inverseJoinColumns = {@JoinColumn(name = "toa_pk")}
    )
    private List<SgTipoOrganismoAdministrativo> tiposOrganismoCurricular;
    ...
    @OneToMany(mappedBy = "componentePresupuestoEscolar")
    private List<RelacionGesPresEsAnioFiscal> relacionGesPresEsAnioFiscals;
    
    public ComponentePresupuestoEscolar() {
        this.habilitado = Boolean.TRUE;
        this.subareasInversion = new ArrayList<>();
        this.tiposOrganismoCurricular = new ArrayList<>();
        if(this.id != null) {
    ...
    public CategoriaPresupuestoEscolar getCategoriaPresupuestoEscolar() {
        return categoriaPresupuestoEscolar;
    }

    public void setCategoriaPresupuestoEscolar(CategoriaPresupuestoEscolar categoriaPresupuestoEscolar) {
        this.categoriaPresupuestoEscolar = categoriaPresupuestoEscolar;
    }

    public List<AreasInversion> getSubareasInversion() {
        return subareasInversion;
    }

    public void setSubareasInversion(List<AreasInversion> subareasInversion) {
    ...
    public boolean equals(Object object) {
        ...
        ComponentePresupuestoEscolar other = (ComponentePresupuestoEscolar) object;
    ...
    public String toString() {
        return "ComponentePresupuestoEscolar{" + "id=" + id + ", cod=" + cod + ", nombre=" + nombre + ", nombreBusqueda=" + nombreBusqueda + ", descripcion=" + descripcion + ", proyecto=" + proyecto + ", subactividad=" + subactividad + ", categoria=" + categoria + ", convenio=" + convenio + ", categoriaGastoConvenio=" + categoriaGastoConvenio + ", tipoTransferencia=" + tipoTransferencia + ", habilitado=" + habilitado + ", categoriaPresupuestoEscolar=" + categoriaPresupuestoEscolar + ", tipo=" + tipo + ", tipoCuentaBancaria=" + tipoCuentaBancaria + ", parametro=" + parametro + ", unidadMedida=" + unidadMedida + ", montoMinimo=" + montoMinimo + ", cantidadAnio=" + cantidadAnio + ", concepto=" + concepto + ", subareasInversion=" + subareasInversion + ", tiposOrganismoCurricular=" + tiposOrganismoCurricular + ", tipoCredito=" + tipoCredito + ", unidadTecnica=" + unidadTecnica + ", tipoEjecucion=" + tipoEjecucion + ", ceduOficiales=" + ceduOficiales + ", ceduPrivadosSub=" + ceduPrivadosSub + ", ceduPrivadosNoSub=" + ceduPrivadosNoSub + ", circulosFamilia=" + circulosFamilia + ", sedesEducame=" + sedesEducame + ", circulosAlfabetizacion=" + circulosAlfabetizacion + ", sedesAdscritas=" + sedesAdscritas + ", usuario=" + usuario + ", ultMod=" + ultMod + ", ultUsuario=" + ultUsuario + ", version=" + version + ", relacionGesPresEsAnioFiscals=" + relacionGesPresEsAnioFiscals + '}';
    }
    ...
    public List<RelacionGesPresEsAnioFiscal> getRelacionGesPresEsAnioFiscals() {
        return relacionGesPresEsAnioFiscals;
    }

    public void setRelacionGesPresEsAnioFiscals(List<RelacionGesPresEsAnioFiscal> relacionGesPresEsAnioFiscals) {
        this.relacionGesPresEsAnioFiscals = relacionGesPresEsAnioFiscals;
    }

    public List<SgTipoOrganismoAdministrativo> getTiposOrganismoCurricular() {
        return tiposOrganismoCurricular;
    }

    public void setTiposOrganismoCurricular(List<SgTipoOrganismoAdministrativo> tiposOrganismoCurricular) {
        this.tiposOrganismoCurricular = tiposOrganismoCurricular;
    }
