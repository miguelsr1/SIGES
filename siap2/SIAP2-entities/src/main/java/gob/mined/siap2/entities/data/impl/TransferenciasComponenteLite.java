...
@Cacheable(false)
public class TransferenciasComponenteLite implements Serializable{
    ...
    private CategoriaPresupuestoEscolarLite componente;
    
    @ManyToOne
    @JoinColumn(name = "tc_subcomponente")
    private ComponentePresupuestoEscolarLite subcomponente;
    ...
    private TransferenciaLite transferencia;
    ...
    public CategoriaPresupuestoEscolarLite getComponente() {
        return componente;
    }

    public void setComponente(CategoriaPresupuestoEscolarLite componente) {
        this.componente = componente;
    }

    public ComponentePresupuestoEscolarLite getSubcomponente() {
        return subcomponente;
    }

    public void setSubcomponente(ComponentePresupuestoEscolarLite subcomponente) {
    ...
    public boolean equals(Object obj) {
        ...
        final TransferenciasComponenteLite other = (TransferenciasComponenteLite) obj;
    ...
    public TransferenciaLite getTransferencia() {
        return transferencia;
    }

    public void setTransferencia(TransferenciaLite transferencia) {
