...
@Cacheable(false)
public class FuenteRecursos implements BaseCodiguera, Serializable {
    @Id
    ...
    public boolean equals(Object obj) {
        ...
        final FuenteRecursos other = (FuenteRecursos) obj;
    ...
    public String toString() {
        return "FuenteRecursos{" + "id=" + id + ", nombre=" + nombre + ", nombreBusqueda=" + nombreBusqueda + ", codigo=" + codigo + ", habilitado=" + habilitado + ", orden=" + orden + ", fuenteFinanciamiento=" + fuenteFinanciamiento + ", ultUsuario=" + ultUsuario + ", ultMod=" + ultMod + ", version=" + version + '}';
    }
