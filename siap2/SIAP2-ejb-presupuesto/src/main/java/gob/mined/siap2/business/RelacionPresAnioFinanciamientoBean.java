 ...
 */
@Stateless(name = "relacionPresAnioFinanciamiento")
@LocalBean
public class RelacionPresAnioFinanciamientoBean {

    private static final Logger logger = Logger.getLogger(RelacionPresAnioFinanciamientoBean.class.getName());
