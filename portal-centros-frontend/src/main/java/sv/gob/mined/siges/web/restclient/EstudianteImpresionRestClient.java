...
public class EstudianteImpresionRestClient implements Serializable {
    ...
    public SgEstudianteImpresion obtenerPorId(Long estudianteImpresionPk) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
        if (estudianteImpresionPk == null) {
            return null;
        }
        ...
        webTarget = webTarget.path(estudianteImpresionPk.toString());
        return restClient.invokeGet(webTarget, SgEstudianteImpresion.class);
    }
