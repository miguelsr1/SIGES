...
public class FiltroModalidad implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 67 * hash + Objects.hashCode(this.cicPk);
        hash = 67 * hash + Objects.hashCode(this.orgCurricularPk);
        hash = 67 * hash + Objects.hashCode(this.modHabilitado);
        ...
        hash = 67 * hash + Objects.hashCode(this.inicializarRel);
        return hash;
    }
