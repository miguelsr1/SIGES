...
public class SgServicioEducativo implements Serializable {
    ...
    @JsonIgnore
    private HashMap<Integer, Integer> sduSumaMatriculasPorAnio;
    ...
    public HashMap<Integer, Integer> getSduSumaMatriculasPorAnio() {
        return sduSumaMatriculasPorAnio;
    }

    public void setSduSumaMatriculasPorAnio(HashMap<Integer, Integer> sduSumaMatriculasPorAnio) {
        this.sduSumaMatriculasPorAnio = sduSumaMatriculasPorAnio;
    }
