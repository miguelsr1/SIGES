...
public class FiltroRelModEdModAten implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 67 * hash + Objects.hashCode(this.reaModalidadEducativa);
        hash = 67 * hash + Objects.hashCode(this.reaModalidadAtencion);
        hash = 67 * hash + Objects.hashCode(this.reaSubModalidad);
        hash = 67 * hash + Objects.hashCode(this.reaNivel);
        hash = 67 * hash + Objects.hashCode(this.sedePk);
        hash = 67 * hash + Objects.hashCode(this.inicializarGrados);
