...
@Named
@ViewScoped
public class ReposicionTituloBean implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(ReposicionTituloBean.class.getName());
    ...
    public void buscar() {
        try {
            filtro.setSimTipoImpresion(EnumTipoSolicitudImpresion.REP);
	...
	JSFUtils.limpiarMensajesError();
        ...
        entidadEnEdicion.getRetSolicitudImpresion().setSimTipoImpresion(EnumTipoSolicitudImpresion.REP);
