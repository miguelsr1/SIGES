 ...
 */
public class FiltroHabitosAlimentacion implements Serializable {
    
    private Long anioLectivoPk;
    private Long fichaEstudianteFk;
    private Boolean incluirTiempoComida;
    ...
    public FiltroHabitosAlimentacion(){
    ...
    public Boolean getIncluirTiempoComida() {
        return incluirTiempoComida;
    }

    public void setIncluirTiempoComida(Boolean incluirTiempoComida) {
        this.incluirTiempoComida = incluirTiempoComida;
    }
