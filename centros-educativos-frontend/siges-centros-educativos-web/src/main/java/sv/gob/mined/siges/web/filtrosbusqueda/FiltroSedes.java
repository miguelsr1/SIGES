...
public class FiltroSedes implements Serializable {
    ...
    public FiltroSedes() {
        ...
        this.incluirAdscritas = Boolean.TRUE;
    }
    ...
    public String toString() {
        return "FiltroSedes{" + "sedPk=" + sedPk + ", sedNombre=" + sedNombre + ", sedCodigo=" + sedCodigo + ", sedCodigoONombre=" + sedCodigoONombre + ", sedLegalizada=" + sedLegalizada + ", sedDepartamentoId=" + sedDepartamentoId + ", sedMunicipioId=" + sedMunicipioId + ", sedZonaId=" + sedZonaId + ", sedTipo=" + sedTipo + ", sedTipoCalendario=" + sedTipoCalendario + ", priSubvencionada=" + priSubvencionada + ", sedServicioEducativo=" + sedServicioEducativo + ", cedFineDeLucro=" + cedFineDeLucro + ", cedTipoOrganismoAdministrativoPk=" + cedTipoOrganismoAdministrativoPk + ", sedHabilitado=" + sedHabilitado + ", sedRevisado=" + sedRevisado + ", sedNivel=" + sedNivel + ", sedCiclo=" + sedCiclo + ", sedModalidadEducativa=" + sedModalidadEducativa + ", sedOpcion=" + sedOpcion + ", sedGrado=" + sedGrado + ", sedProgramaEducativo=" + sedProgramaEducativo + ", sedModalidadAtencion=" + sedModalidadAtencion + ", sedSubModalidad=" + sedSubModalidad + ", sedAdscritaPk=" + sedAdscritaPk + ", first=" + first + ", maxResults=" + maxResults + ", orderBy=" + orderBy + ", ascending=" + ascending + ", incluirCampos=" + Arrays.deepToString(incluirCampos) + ", securityOperation=" + securityOperation + ", incluirSiTieneAdscritas=" + incluirSiTieneAdscritas + ", utilizarFiltrosEnSedePadre=" + utilizarFiltrosEnSedePadre + ", incluirAdscritas=" + incluirAdscritas + ", incluirJornadas=" + incluirJornadas + '}';
    }
