...
/**
 *
 * @author Sofis Solutions. Utilizado cuando es necesario tener dos componentes de selección de sección en la misma pag.
 */
@Named
@ViewScoped
public class SeleccionarSeccionBean2 implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(SeleccionarSeccionBean2.class.getName());
    ...
    public void init() {
        try {
            ...
            entidadEnEdicion = (SgSeccion) request.getAttribute("seccion2");
            retornarSoloSeccionesAbiertas = (Boolean) request.getAttribute("retornarSoloSeccionesAbiertas2");
            securityOperation = (String) request.getAttribute("securityOperation2");
            sedeEnEdicion=(SgSede) request.getAttribute("sede2");
    ...
    public void cargarSedePorDefecto() throws Exception {
        if (sessionBean.getSedeDefecto() != null) {
            ...
            if(sedeEnEdicion!=null){
                    sedeSeleccionada =sedeEnEdicion;
                    seleccionarSede();
            }
        }
    ...
    public void seleccionarAnioLectivo() {
        try {
            ...
            if (comboGrado.getSelectedT() != null && comboAnioLectivo.getSelectedT() != null) {   
                ...
                comboSeccion = new SofisComboG(new ArrayList(seccion), "secNombre");
    ...
    private void actualizarSeccion() {
        try {
            ...
            String expr = "#{controllerParam2[actionParam2](seleccionarSeccionBean2.comboSeccion.selectedT)}";
