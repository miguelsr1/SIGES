...
public class FiltroRelPeriodosHabilitacionPeriodo implements Serializable {
    ...
    private List<EnumTiposPeriodosCalificaciones> rphTipoPeriodoCalificacionList;
    ...
    public List<EnumTiposPeriodosCalificaciones> getRphTipoPeriodoCalificacionList() {
        return rphTipoPeriodoCalificacionList;
    }

    public void setRphTipoPeriodoCalificacionList(List<EnumTiposPeriodosCalificaciones> rphTipoPeriodoCalificacionList) {
        this.rphTipoPeriodoCalificacionList = rphTipoPeriodoCalificacionList;
    }
