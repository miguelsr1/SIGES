...
public class FiltroTipoRepresentante implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + Objects.hashCode(this.cargoPk);
        hash = 59 * hash + Objects.hashCode(this.cargosPk);
    ...
    public boolean equals(Object obj) {
        ...
        final FiltroTipoRepresentante other = (FiltroTipoRepresentante) obj;
        ...
        if (!Objects.equals(this.cargoPk, other.cargoPk)) {
            return false;
        }
        if (!Objects.equals(this.cargosPk, other.cargosPk)) {
            return false;
        }
