...
@Named
@ApplicationScoped
public class EnfermedadNoTransmisibleConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
            return restClient.obtenerPorIdEnfermedadNoTransmitible(Long.valueOf(value));
        } catch (Exception ex) {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object o) {
        if (o == null) {
            return null;
        } else if (o instanceof SgEnfermedadNoTransmisible) {
            return String.valueOf(((SgEnfermedadNoTransmisible) o).getEntPk());
