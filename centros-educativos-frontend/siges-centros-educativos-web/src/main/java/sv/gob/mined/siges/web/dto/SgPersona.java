...
//    private SgTipoServicioSanitario perTipoServicioSanitario;
    ...
    @JsonIgnore
    private Boolean perSePermiteModificarIdentificacion;
    @JsonIgnore
    private Boolean perVisualizadaComoEstudiante;
    @JsonIgnore
    private String perDUIGuardado; //Utilizado para comparar contra nuevo dui y saber si el mismo fue modificado antes de consultar a RNPN
    @JsonIgnore
    private Long perCUNGuardado; //Utilizado para comparar contra nuevo cun y saber si el mismo fue modificado antes de consultar a RNPN
    @JsonIgnore
    private Long perPartidaNacimientoGuardado;
    @JsonIgnore
    private Integer perPartidaNacimientoAnioGuardado;
    @JsonIgnore
    private String perPartidaNacimientoFolioGuardado;
    @JsonIgnore
    private String perPartidaNacimientoLibroGuardado;
    @JsonIgnore
    private String perPartidaNacimientoComplementoGuardado; //Utilizado para comparar contra nuevos datos partida y saber si la misma fue modificada antes de consultar a RNPN
    @JsonIgnore
    private SgDepartamento perPartidaDepartamentoGuardado;
    @JsonIgnore
    private SgMunicipio perPartidaMunicipioGuardado;

    public SgPersona() {
        this.perDuiValidadoRNPN = Boolean.FALSE;
        this.perDuiPendienteValidacionRNPN = Boolean.FALSE;
        this.perCunValidadoRNPN = Boolean.FALSE;
        this.perCunPendienteValidacionRNPN = Boolean.FALSE;
        this.perPartidaNacValidadaRNPN = Boolean.FALSE;
        this.perPartidaNacPendienteValidacionRNPN = Boolean.FALSE;
        ...
        this.perDiscapacidades = new ArrayList();
        ...
        this.perSePermiteModificarIdentificacion = Boolean.FALSE;
        this.perVisualizadaComoEstudiante = Boolean.FALSE;
        ...
        this.perDatosResidenciales = new SgDatosResidencialesPersona();
    }
    ...
    public String getNieNombre() {
        if (this.perNie != null) {
            ...
            return this.getPerNombreCompleto();
        }
    }

    @JsonIgnore
    public String getReferenciasApoyoAsString() {
        if (this.perReferenciasApoyo != null) {
            return this.perReferenciasApoyo.stream().map(d -> d.getReaNombre()).collect(Collectors.joining(", "));
        }
        return null;
    }

    @JsonIgnore
    public String getTerapiasAsString() {
        if (this.perTerapias != null) {
            return this.perTerapias.stream().map(d -> d.getTerNombre()).collect(Collectors.joining(", "));
        }
        return null;
    }
    ...
    public void setPerDui(String perDui) {
        ...
        this.perDui = perDui;
        if (this.perDUIGuardado == null) {
            this.perDUIGuardado = this.perDui;
        }
    }
    ...
    public void setPerCun(Long perCun) {
        this.perCun = perCun;
        if (this.perCUNGuardado == null) {
            this.perCUNGuardado = this.perCun;
        }
    }
    ...
    public void setPerNip(String perNip) {
        if (!StringUtils.isEmpty(perNip)) {
            perNip = StringUtils.leftPad(perNip, 7, "0");
        }
        this.perNip = perNip;
    }
    ...
    public void setPerPartidaNacimiento(Long perPartidaNacimiento) {
        ...
        if (this.perPartidaNacimientoGuardado == null) {
            this.perPartidaNacimientoGuardado = this.perPartidaNacimiento;
        }
    }
    ...
    public void setPerPartidaNacimientoFolio(String perPartidaNacimientoFolio) {
        ...
        if (this.perPartidaNacimientoFolioGuardado == null) {
            this.perPartidaNacimientoFolioGuardado = this.perPartidaNacimientoFolio;
        }
    }
    ...
    public void setPerPartidaNacimientoLibro(String perPartidaNacimientoLibro) {
        ...
        if (this.perPartidaNacimientoLibroGuardado == null) {
            this.perPartidaNacimientoLibroGuardado = this.perPartidaNacimientoLibro;
        }
    }
    ...
    public void setPerPartidaNacimientoComplemento(String perPartidaNacimientoComplemento) {
        ...
        if (this.perPartidaNacimientoComplementoGuardado == null) {
            this.perPartidaNacimientoComplementoGuardado = this.perPartidaNacimientoComplemento;
        }
    }
    ...
    public void setPerPartidaNacimientoAnio(Integer perPartidaNacimientoAnio) {
        ...
        if (this.perPartidaNacimientoAnioGuardado == null) {
            this.perPartidaNacimientoAnioGuardado = this.perPartidaNacimientoAnio;
        }
    }
    ...
    public void setPerPartidaDepartamento(SgDepartamento perPartidaDepartamento) {
        ...
        if (this.perPartidaDepartamentoGuardado == null) {
            this.perPartidaDepartamentoGuardado = this.perPartidaDepartamento;
        }
    }
    ...
    public void setPerPartidaMunicipio(SgMunicipio perPartidaMunicipio) {
        ...
        if (this.perPartidaMunicipioGuardado == null) {
            this.perPartidaMunicipioGuardado = this.perPartidaMunicipio;
        }
    }
    ...
    public Boolean getPerSePermiteModificarIdentificacion() {
        return perSePermiteModificarIdentificacion;
    }

    public void setPerSePermiteModificarIdentificacion(Boolean perSePermiteModificarIdentificacion) {
        this.perSePermiteModificarIdentificacion = perSePermiteModificarIdentificacion;
    }
    ...
    public Boolean getPerVisualizadaComoEstudiante() {
        return perVisualizadaComoEstudiante;
    }

    public void setPerVisualizadaComoEstudiante(Boolean perVisualizadaComoEstudiante) {
        this.perVisualizadaComoEstudiante = perVisualizadaComoEstudiante;
    }
    ...
    public String getPerDUIGuardado() {
        return perDUIGuardado;
    }

    public void setPerDUIGuardado(String perDUIGuardado) {
        this.perDUIGuardado = perDUIGuardado;
    }

    public Long getPerCUNGuardado() {
        return perCUNGuardado;
    }

    public void setPerCUNGuardado(Long perCUNGuardado) {
        this.perCUNGuardado = perCUNGuardado;
    }

    public Long getPerPartidaNacimientoGuardado() {
        return perPartidaNacimientoGuardado;
    }

    public void setPerPartidaNacimientoGuardado(Long perPartidaNacimientoGuardado) {
        this.perPartidaNacimientoGuardado = perPartidaNacimientoGuardado;
    }

    public Integer getPerPartidaNacimientoAnioGuardado() {
        return perPartidaNacimientoAnioGuardado;
    }

    public void setPerPartidaNacimientoAnioGuardado(Integer perPartidaNacimientoAnioGuardado) {
        this.perPartidaNacimientoAnioGuardado = perPartidaNacimientoAnioGuardado;
    }

    public String getPerPartidaNacimientoFolioGuardado() {
        return perPartidaNacimientoFolioGuardado;
    }

    public void setPerPartidaNacimientoFolioGuardado(String perPartidaNacimientoFolioGuardado) {
        this.perPartidaNacimientoFolioGuardado = perPartidaNacimientoFolioGuardado;
    }

    public String getPerPartidaNacimientoLibroGuardado() {
        return perPartidaNacimientoLibroGuardado;
    }

    public void setPerPartidaNacimientoLibroGuardado(String perPartidaNacimientoLibroGuardado) {
        this.perPartidaNacimientoLibroGuardado = perPartidaNacimientoLibroGuardado;
    }

    public String getPerPartidaNacimientoComplementoGuardado() {
        return perPartidaNacimientoComplementoGuardado;
    }

    public void setPerPartidaNacimientoComplementoGuardado(String perPartidaNacimientoComplementoGuardado) {
        this.perPartidaNacimientoComplementoGuardado = perPartidaNacimientoComplementoGuardado;
    }

    public SgDepartamento getPerPartidaDepartamentoGuardado() {
        return perPartidaDepartamentoGuardado;
    }

    public void setPerPartidaDepartamentoGuardado(SgDepartamento perPartidaDepartamentoGuardado) {
        this.perPartidaDepartamentoGuardado = perPartidaDepartamentoGuardado;
    }

    public SgMunicipio getPerPartidaMunicipioGuardado() {
        return perPartidaMunicipioGuardado;
    }

    public void setPerPartidaMunicipioGuardado(SgMunicipio perPartidaMunicipioGuardado) {
        this.perPartidaMunicipioGuardado = perPartidaMunicipioGuardado;
    }
