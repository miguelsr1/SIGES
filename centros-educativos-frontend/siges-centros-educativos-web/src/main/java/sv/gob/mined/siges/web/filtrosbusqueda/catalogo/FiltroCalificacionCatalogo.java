...
public class FiltroCalificacionCatalogo implements Serializable {
    ...
    public FiltroCalificacionCatalogo() {
    }
    ...
    public int hashCode() {
        int hash = 3;
        hash = 19 * hash + Objects.hashCode(this.ecaCalPk);
        hash = 19 * hash + Objects.hashCode(this.calCodigo);
        hash = 19 * hash + Objects.hashCode(this.calCodigoExacto);
        hash = 19 * hash + Objects.hashCode(this.calValor);
        hash = 19 * hash + Objects.hashCode(this.calOrden);
        hash = 19 * hash + Objects.hashCode(this.calHabilitado);
        hash = 19 * hash + Objects.hashCode(this.calEscala);
        hash = 19 * hash + Objects.hashCode(this.calEscalaExacto);
        hash = 19 * hash + Objects.hashCode(this.calEscalaCalificacionPk);
    ...
    public boolean equals(Object obj) {
        ...
        final FiltroCalificacionCatalogo other = (FiltroCalificacionCatalogo) obj;
