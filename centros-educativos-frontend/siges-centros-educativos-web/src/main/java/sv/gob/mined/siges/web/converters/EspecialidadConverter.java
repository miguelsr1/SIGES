...
public class EspecialidadConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
            return restClient.obtenerPorIdEspecialidad(Long.valueOf(value));
        } catch (Exception ex) {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object o) {
        if (o == null) {
            return null;
        } else if (o instanceof SgEspecialidad) {
            return String.valueOf(((SgEspecialidad) o).getEspPk());
        } else if (o instanceof String) {
            if (StringUtils.isBlank((String) o)) {
                return null;
            }
        }
        throw new ConverterException(new FacesMessage(o + " is not a valid especialidad"));
    }
}
