...
public class LazyLucenePersonaDataModel extends LazyDataModel<SgPersona> implements Serializable {   
    

    private static final Logger LOGGER = Logger.getLogger(LazyLucenePersonaDataModel.class.getName());

    
    private static final long serialVersionUID = 1L;
    private PersonaRestClient restClient;
    private FiltroPersona filtro;
    private Boolean luceneEnabled=Boolean.TRUE;
    
    public LazyLucenePersonaDataModel(PersonaRestClient restClient, FiltroPersona filtro, Long rowCount, Integer pageSize) {
    ...
    public List<SgPersona> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        try {
            ...
            if(this.luceneEnabled){
                return restClient.buscarLucene(filtro);
            }else{
