...
public class FiltroTipoServicioSanitario implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + Objects.hashCode(this.auxiliar);
        hash = 97 * hash + Objects.hashCode(this.tssAplicaEstudiante);
        hash = 97 * hash + Objects.hashCode(this.tssAplicaInmueble);
        hash = 97 * hash + Objects.hashCode(this.tssAplicaEdificio);
