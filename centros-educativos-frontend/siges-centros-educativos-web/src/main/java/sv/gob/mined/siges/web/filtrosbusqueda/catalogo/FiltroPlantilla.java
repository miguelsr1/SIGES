...
public class FiltroPlantilla implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 79 * hash + Objects.hashCode(this.fechaHabilitado);
        hash = 79 * hash + Objects.hashCode(this.fechaDeshabilitado);
        hash = 79 * hash + Objects.hashCode(this.habilitadaReemplazoOrg);
        hash = 79 * hash + Objects.hashCode(this.orgCurricularPk);
        hash = 79 * hash + Objects.hashCode(this.soloPlantillasPorDefecto);
