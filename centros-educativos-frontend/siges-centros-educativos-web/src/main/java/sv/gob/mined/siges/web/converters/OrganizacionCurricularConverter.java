...
@Named
@ApplicationScoped
public class OrganizacionCurricularConverter implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object o) {
        if (o == null) {
            return null;
        } else if (o instanceof SgOrganizacionCurricular) {
            return String.valueOf(((SgOrganizacionCurricular) o).getOcuPk());
        } else if (o instanceof String) {
            if (StringUtils.isBlank((String) o)) {
                return null;
            }
        }
        throw new ConverterException(new FacesMessage(o + " is not a valid Organización Curricular"));
    }
}