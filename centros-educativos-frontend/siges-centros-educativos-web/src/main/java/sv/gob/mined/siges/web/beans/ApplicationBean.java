...
public class ApplicationBean implements Serializable {
    ...
    @Inject
    @ConfigProperty(name = "service.simple-nuevo-servicio-educativo.baseUrl")
    private String simpleNuevoServicioEducativoUrl;
    ...
    private String infraestructuraUrl;
    ...
    private final String rowsPerPageTemplate = "5,10,20";
    private final String rowsPerPageTemplate2 = "5,10,25,50,100";
    ...
    public SelectItem[] getAsistenciasInasistenciasValues() {
        return new SelectItem[]{
            new SelectItem(Boolean.TRUE, "Asistencias"),
            new SelectItem(Boolean.FALSE, "Inasistencias")
        };
    }
    
    
    public Boolean estaEnRango(LocalDate inicio, LocalDate fin, LocalDate fecha){
        try{
            return (fecha.isAfter(inicio) || fecha.equals(inicio)) && (fecha.isBefore(fin) || fecha.equals(fin));
        }catch(Exception ex){
            LOGGER.log(Level.SEVERE, null, ex);
        }
        return false;
    ...
    public String getSimpleNuevoServicioEducativoUrl() {
        return simpleNuevoServicioEducativoUrl;
    }
    ...
    public String getInfraestructuraUrl() {
        return infraestructuraUrl;
    }

    public void setInfraestructuraUrl(String infraestructuraUrl) {
        this.infraestructuraUrl = infraestructuraUrl;
    }
