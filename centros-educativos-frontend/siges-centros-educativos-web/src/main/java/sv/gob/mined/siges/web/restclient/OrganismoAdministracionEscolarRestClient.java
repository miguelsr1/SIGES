...
public class OrganismoAdministracionEscolarRestClient implements Serializable {
    ...
    public SgOrganismoAdministracionEscolar guardarRenovarMiembro(SgOAEyMiembros organismoAdministracionEscolar) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
        if (organismoAdministracionEscolar == null) {
            return null;
        }
 
            WebTarget webTarget = RestClient.getWebTarget(client, ConstantesServiciosRest.SERVICIO_CENTROS_EDUCATIVOS, "v1/organismoadministracionescolar/guardarRenovarMiembro");
            return restClient.invokePost(webTarget, organismoAdministracionEscolar, SgOrganismoAdministracionEscolar.class);
       
    }

    public void enviar(Long pk) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
        if (pk == null) {
            return;
        }
        WebTarget webTarget = RestClient.getWebTarget(client, ConstantesServiciosRest.SERVICIO_CENTROS_EDUCATIVOS, "v1/organismoadministracionescolar/enviar");
        restClient.invokePost(webTarget, pk, null);
    }
    ...
    public SgOrganismoAdministracionEscolar obtenerEnRevision(Long estudiantePk, Long estudianteRev) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException {
        if (estudiantePk == null || estudianteRev == null) {
            return null;
        }
        WebTarget webTarget = RestClient.getWebTarget(client, ConstantesServiciosRest.SERVICIO_CENTROS_EDUCATIVOS, "v1/organismoadministracionescolar/revision");
