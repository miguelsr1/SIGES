...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class, property = "bnfPk", scope = SgBeneficio.class)
public class SgBeneficio implements Serializable {
    ...
    public Boolean getIsTipoEstudiante(){
        return this.bnfTipoBeneficio.equals(EnumTipoBeneficio.ESTUDIANTE);
    }
