...
import sv.gob.mined.siges.web.lazymodels.LazyConsultaCalificacionesPendientesSedeEnNivelDataModel;
...
@Named
@ViewScoped
public class ConsultaCalificacionesPendientesBean implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(ConsultaCalificacionesPendientesBean.class.getName());

    @Inject
    private CalificacionRestClient controlAsistenciaClient;
    ...
    private FiltroCalificacionesPendientesSedeEnNivel filtro = new FiltroCalificacionesPendientesSedeEnNivel();

    private LazyConsultaCalificacionesPendientesSedeEnNivelDataModel consultaCalificacionesPendientesSedeEnNivelLazyModel;
    ...
    public void cargarCombos() {
        try {
            ...
            List<SgDepartamento> listaDepartamentos = sessionBean.obtenerDepartamentosOperacion(ConstantesOperaciones.BUSCAR_CALIFICACIONES_PENDIENTES_POR_SEDE);
    ...
    public void generar() {
        try {
            ...
            consultaCalificacionesPendientesSedeEnNivelLazyModel = new LazyConsultaCalificacionesPendientesSedeEnNivelDataModel(controlAsistenciaClient, filtro, totalResultados, paginado);
    ...
    public void limpiar() {
        filtro = new FiltroCalificacionesPendientesSedeEnNivel();
        this.comboDepartamentos.setSelected(0);
        this.comboMunicipios.setSelected(0);
        this.sedeSeleccionada = null;
        this.comboNiveles.setSelected(0);
        this.consultaCalificacionesPendientesSedeEnNivelLazyModel = null;
    }

    public FiltroCalificacionesPendientesSedeEnNivel getFiltro() {
        return filtro;
    }
    ...
    public LazyConsultaCalificacionesPendientesSedeEnNivelDataModel getConsultaCalificacionesPendientesSedeEnNivelLazyModel() {
        return consultaCalificacionesPendientesSedeEnNivelLazyModel;
    }

    public void setConsultaCalificacionesPendientesSedeEnNivelLazyModel(LazyConsultaCalificacionesPendientesSedeEnNivelDataModel consultaCalificacionesPendientesSedeEnNivelLazyModel) {
        this.consultaCalificacionesPendientesSedeEnNivelLazyModel = consultaCalificacionesPendientesSedeEnNivelLazyModel;
    }
