...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class, property = "puiPk", scope = SgPerfilesUsuariosIngresadosCe.class)
public class SgPerfilesUsuariosIngresadosCe implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 59 * hash + Objects.hashCode(this.puiPk);
        return hash;
    }
