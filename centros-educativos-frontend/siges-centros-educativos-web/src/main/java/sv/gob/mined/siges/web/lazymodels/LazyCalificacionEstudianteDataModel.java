...
public class LazyCalificacionEstudianteDataModel extends LazyDataModel<SgCalificacionCE> implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(LazyCalificacionEstudianteDataModel.class.getName());
    private static final long serialVersionUID = 1L;
    private CalificacionRestClient restClient;
    private FiltroCalificacion filtro;

    public LazyCalificacionEstudianteDataModel(CalificacionRestClient restClient, FiltroCalificacion filtro, Long rowCount, Integer pageSize) {
