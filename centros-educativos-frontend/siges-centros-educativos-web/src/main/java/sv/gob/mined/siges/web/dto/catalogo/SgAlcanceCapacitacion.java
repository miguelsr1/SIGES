...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class, property = "acaPk", scope = SgAlcanceCapacitacion.class)
