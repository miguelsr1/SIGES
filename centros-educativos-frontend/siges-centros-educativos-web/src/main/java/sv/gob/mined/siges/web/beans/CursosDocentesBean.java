...
@Named
@ViewScoped
public class CursosDocentesBean implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(CursosDocentesBean.class.getName());
    ...
    private SofisComboG<EnumEstadoCurso> comboEstadoCurso;
    ...
    public String buscar() {
        try {
            ...
            filtro.setCdsEstado(comboEstadoCurso.getSelectedT());
    ...
    public void cargarCombos() {
        try {
            ...
            List<EnumEstadoCurso> estados = new ArrayList(Arrays.asList(EnumEstadoCurso.values()));
            comboEstadoCurso = new SofisComboG(estados, "text");
            comboEstadoCurso.addEmptyItem(Etiquetas.getValue("comboEmptyItem"));
    ...
    public void limpiar() {
        ...
        comboEstadoCurso.setSelected(-1);
        buscar();
    }
    ...
    public SofisComboG<EnumEstadoCurso> getComboEstadoCurso() {
        return comboEstadoCurso;
    }

    public void setComboEstadoCurso(SofisComboG<EnumEstadoCurso> comboEstadoCurso) {
        this.comboEstadoCurso = comboEstadoCurso;
    }
