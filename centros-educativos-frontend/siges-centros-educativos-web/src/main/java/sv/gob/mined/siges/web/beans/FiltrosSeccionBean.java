...
public class FiltrosSeccionBean implements Serializable {
    ...
    private Boolean renderSeccionIntegrada = Boolean.FALSE;
    private Boolean esInternacional=Boolean.FALSE;
    
    private Boolean renderFiltrosSeccion = Boolean.FALSE;

    private FiltroSeccion filtro;
    
    private List<SelectItem> comboEstadoSeccion;
    ...
    public void limpiarCombos() {
        ...
        if (!disableAnioLectio) {
            ...
            filtro.setSecAnioLectivoAnio(null);
        }
    ...
    public void seleccionarUltimoAnio() {
        try {
            ...
            filtro.setSecAnioLectivoAnio(comboAnioLectivo.getSelectedT().getAleAnio());
        } catch (Exception ex) {
            LOGGER.log(Level.SEVERE, LoggingUtils.getMessage(this.sessionBean.getUser(), ex), ex);
            JSFUtils.agregarError(ConstantesComponentesId.ID_MSG_TEMPLATE, Mensajes.obtenerMensaje(Mensajes.ERROR_GENERAL), "");
        }
    ...
    public void seleccionarSede() {
        try {
            ...
            if (this.sedeSeleccionada != null) {
                ...
                esInternacional=sedeSeleccionada.getSedTipoCalendario()!=null?sedeSeleccionada.getSedTipoCalendario().getTceCodigo().equals(Constantes.CALENDARIO_INTERNACIONAL):Boolean.FALSE;
            }
    ...
    public void seleccionarAnioLectivo() {
        try {
            ...
            if (comboGrado.getSelectedT() != null && comboAnioLectivo.getSelectedT() != null && sedeSeleccionada != null) {
                ...
                fSeccion.setIncluirCampos(new String[]{"secJornadaLaboral.jlaNombre","secServicioEducativo.sduGrado.graPk",
    ...
    public void seleccionarSeccion() {
        ...
        String expr = "#{controllerParam[actionParam](filtrosSeccionBean.comboSeccion.selectedT)}";
    ...
    public List<SgSede> completeSede(String query) {
        try {
            ...
            fil.setIncluirCampos(new String[]{"sedCodigo", "sedNombre", "sedTipo", "sedVersion","sedTipoCalendario.tcePk","sedTipoCalendario.tceCodigo"});
    ...
    public List<SelectItem> getComboEstadoSeccion() {
        return comboEstadoSeccion;
    }

    public void setComboEstadoSeccion(List<SelectItem> comboEstadoSeccion) {
        this.comboEstadoSeccion = comboEstadoSeccion;
    }

    public Boolean getRenderFiltrosSeccion() {
        return renderFiltrosSeccion;
    }

    public void setRenderFiltrosSeccion(Boolean renderFiltrosSeccion) {
        this.renderFiltrosSeccion = renderFiltrosSeccion;
    }
