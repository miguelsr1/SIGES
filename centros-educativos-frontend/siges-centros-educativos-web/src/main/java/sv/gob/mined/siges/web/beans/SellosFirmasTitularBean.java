...
@Named
@ViewScoped
public class SellosFirmasTitularBean implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(SellosFirmasTitularBean.class.getName());
    ...
    public SellosFirmasTitularBean() {
    }
    ...
    public void buscar() {
        try {
            ...
            filtro.setEsTitular(Boolean.TRUE);
