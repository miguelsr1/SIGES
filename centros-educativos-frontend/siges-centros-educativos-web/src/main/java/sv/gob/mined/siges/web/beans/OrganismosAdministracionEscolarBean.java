...
@Named
@ViewScoped
public class OrganismosAdministracionEscolarBean implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(OrganismosAdministracionEscolarBean.class.getName());
    ...
    private List<SelectItem> comboTiposSede;
    ...
    public OrganismosAdministracionEscolarBean() {
    }
    ...
    public void buscar() {
        try {
            ...
            filtro.setIncluirCampos(new String[]{
                ...
                "oaeSede.sedTipo",
                "oaeSede.sedNombre",
                "oaeSede.sedDireccion.dirDepartamento.depNombre",
                "oaeSede.sedDireccion.dirMunicipio.munNombre",
                "oaeActaIntegracion",
                "oaeFechaActaIntegracion",
                "oaeNumeroAcuerdo",
                "oaeFechaAcuerdo",
                "oaeFechaVencimiento",
                "oaeFechaCierre",
    ...
    public void cargarCombos() {
        try {
            ...
            tipoSede.remove(TipoSede.CIR_ALF);
            tipoSede.remove(TipoSede.CIR_INF);
            tipoSede.remove(TipoSede.UBI_EDUC);

            comboTiposSede = new ArrayList(tipoSede);
    ...
    public List<SelectItem> getComboTiposSede() {
        return comboTiposSede;
    }

    public void setComboTiposSede(List<SelectItem> comboTiposSede) {
