...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class,property = "fadPk", scope = SgAfFormaAdquisicion.class)
public class SgAfFormaAdquisicion implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 29 * hash + Objects.hashCode(this.fadPk);
        return hash;
    }
