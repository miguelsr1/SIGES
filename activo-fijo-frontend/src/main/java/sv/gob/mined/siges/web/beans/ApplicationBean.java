...
public class ApplicationBean implements Serializable {
    ...
    @Inject
    @ConfigProperty(name = "service.infraestructura-frontend.baseUrl")
    private String infraestructuraFrontendUrl;
    ...
    private List<TipoSede> tiposSedes;
    ...
    private static final String patternFecha = "dd/MM/yyyy";
    private final String patternHora = "HH:mm";
    private final String patternFechaHora = "dd/MM/yyyy HH:mm";
    private static final DateTimeFormatter dateFormater = DateTimeFormatter.ofPattern(patternFecha);
    ...
    public String getDateFormat(LocalDate date) {
        if(date != null) {
          return date.format(dateFormater);
       }
       return "";
   }
    ...
    public Integer getAnioLimiteMenorAdmitido() {
        return anioLimiteMenorAdmitido;
    }

    public void setAnioLimiteMenorAdmitido(Integer anioLimiteMenorAdmitido) {
        this.anioLimiteMenorAdmitido = anioLimiteMenorAdmitido;
    }

    public String getInfraestructuraFrontendUrl() {
        return infraestructuraFrontendUrl;
    }

    public void setInfraestructuraFrontendUrl(String infraestructuraFrontendUrl) {
        this.infraestructuraFrontendUrl = infraestructuraFrontendUrl;
    }

    public List<TipoSede> getTiposSedes() {
        tiposSedes = new ArrayList();
        tiposSedes.add(TipoSede.CED_OFI);
        tiposSedes.add(TipoSede.CED_PRI);
        return tiposSedes;
    }

    public void setTiposSedes(List<TipoSede> tiposSedes) {
        this.tiposSedes = tiposSedes;
    }
