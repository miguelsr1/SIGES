 ...
 */
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class,property = "etrPk", scope = SgAfEstadosTraslado.class)
