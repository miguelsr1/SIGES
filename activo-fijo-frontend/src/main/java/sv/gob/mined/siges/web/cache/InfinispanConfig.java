...
public class InfinispanConfig {
    ...
    public void init(@Observes @Initialized(ApplicationScoped.class) Object init) throws Exception {
        ...
        manager.createCache(Constantes.FUENTE_FINANCIAMIENTO_AF_CACHE, mutableConfiguration);
        manager.createCache(Constantes.ESTADOS_CALIDAD_CACHE, mutableConfiguration);
        manager.createCache(Constantes.ESTADOS_DESCARGO_CACHE, mutableConfiguration);
        manager.createCache(Constantes.ESTADOS_TRASLADO_CACHE, mutableConfiguration);
        manager.createCache(Constantes.ESTADOS_FORMA_ADQUISICION_CACHE, mutableConfiguration);
        manager.createCache(Constantes.ESTADOS_INVENTARIO_CACHE, mutableConfiguration);
        manager.createCache(Constantes.ESTADOS_BIENES_CACHE, mutableConfiguration);
        manager.createCache(Constantes.TIPOS_TRASLADO_CACHE, mutableConfiguration);
        manager.createCache(Constantes.PROYECTOS_CACHE, mutableConfiguration);
        manager.createCache(Constantes.CATEGORIA_BIENES_CACHE, mutableConfiguration);
        manager.createCache(Constantes.OPCIONES_DESCARGO_CACHE, mutableConfiguration);
    }
