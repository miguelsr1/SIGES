...
public class EmpleadoConverter implements Converter {
    ...
    @Inject
    private EmpleadosRestClient restClient;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object o) {
        if (o == null) {
            return null;
        } else if (o instanceof SgAfEmpleados) {
            return String.valueOf(((SgAfEmpleados) o).getEmpPk());
        } else if (o instanceof String) {
            if (StringUtils.isBlank((String) o)) {
                return null;
            }
        }
        throw new ConverterException(new FacesMessage(o + " is not a valid Empleado"));
    }
}