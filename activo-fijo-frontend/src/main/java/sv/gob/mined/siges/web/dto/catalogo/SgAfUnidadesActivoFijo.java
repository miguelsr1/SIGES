...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class,property = "uafPk", scope = SgAfUnidadesActivoFijo.class)
