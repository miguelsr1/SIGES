...
public class FiltroEspacioComplementario implements Serializable {
    ...
    public FiltroEspacioComplementario() {
    }
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + Objects.hashCode(this.aplicaInmueble);
        hash = 59 * hash + Objects.hashCode(this.aplicaEdificio);
        hash = 59 * hash + Objects.hashCode(this.aplicaAula);
    ...
    public boolean equals(Object obj) {
        ...
        final FiltroEspacioComplementario other = (FiltroEspacioComplementario) obj;
