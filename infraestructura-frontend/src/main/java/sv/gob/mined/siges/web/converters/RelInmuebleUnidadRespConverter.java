...
@Named
@ApplicationScoped
public class RelInmuebleUnidadRespConverter implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object o) {
        if (o == null) {
            return null;
        } else if (o instanceof SgRelInmuebleUnidadResp) {
            return String.valueOf(((SgRelInmuebleUnidadResp) o).getRiuPk());
