...
public class ControlAcceso implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (BooleanUtils.isNotTrue(sessionBean.getEntidadUsuario().getUsuAceptaTerminos()) || 
                    (!sessionBean.getOperaciones().contains(ConstantesOperaciones.TIENE_ACCESO_INFRAESTRUCTURA) && !sessionBean.getOperaciones().contains(ConstantesOperaciones.TIENE_ACCESO_LEGALIZACION_INMUEBLE))) {
