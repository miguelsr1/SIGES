...
import com.sofis.utils.DatesUtils;
...
public class JpaDAOImp<T, ID extends Serializable> implements GenericDAO<T, ID> {
    ...
    @PersistenceContext(unitName = "SIGES-PFEA-PU")
    protected EntityManager entityManager;
    
    private static final Logger logger = Logger.getLogger("com.sofis");
    ...
    public Object findListByQuery(String query, int maxResults) throws DAOGeneralException {
        try {
            Query q = entityManager.createQuery(query).setMaxResults(maxResults);
            return q.getResultList();
        } catch (Exception e) {
            e.printStackTrace();
            DAOGeneralException eDao = new DAOGeneralException(e);
                    ...
                    if (value != null) {
                        if (valueCriteriaTO instanceof MatchCriteriaTO) {
                            ...
                            if (matchType.equalsIgnoreCase(MatchCriteriaTO.types.CONTAINS.getType())) {
                                ...
                                //MB. 28-12-2017 - Se modifica agregando stValue.toUpperCase() para que no discrimine mayúsculas de minúsculas - (Ver MatchCriteriaTO comentario MB. 28-12-2017).
     ...
     * @throws com.sofis.persistence.dao.exceptions.DAOGeneralException
     */
    public List<T> findByOneProperty(Class entidad, String propiedad1, Object valor, String propiedad2, Date propiedad3) throws DAOGeneralException {
        try {
            String sql = "SELECT o from " + entidad.getSimpleName() + " o" + " where o." + propiedad1 + "= :valor"
                    + " or o." + propiedad2 + "< :today";
            Query q = entityManager.createQuery(sql);
            q.setParameter("valor", valor);
             q.setParameter("today", propiedad3, TemporalType.DATE);
            return q.getResultList();
        } catch (Exception e) {
            DAOGeneralException eDao = new DAOGeneralException(e);
            throw eDao;
    ...
    /**
     * Retorna las entidades de clase entidad qeu cumple que la propiedad posee
     * el valor enviado como parametro, obtiene documentos firmado con identificador unico como parametro
     *
     * @param entidad la clase de la entidad
     * @param propiedad el nombre de la propiedad
     * @param valor el valor de la propiedad
     ...
     * @throws com.sofis.persistence.dao.exceptions.DAOGeneralException
     */
    public List<T> findByOneProperty(Class entidad, String propiedad1, Object valor1, String propiedad2, Boolean valor2) throws DAOGeneralException {
        try {
            String sql = "SELECT o from " + entidad.getSimpleName() + " o" + " where o." + propiedad1 + "= :valor1"
                    + " and o." + propiedad2 + "= :valor2";
            Query q = entityManager.createQuery(sql);
