...
public class StringHelper {
    ...
    /**
     * Intenta parsear el texto pasado a un entero; si puede hacerlo y el valor es mayor a 0 devuelve el valor, sino devuelve 0 (cero).
     * @param texto
     * @return 
     */
    public static Integer parsePositiveInt(String texto) {
        try {
