...
@Bulkhead
@CircuitBreaker
@Retry(maxRetries = 3, retryOn = {HttpServerUnavailableException.class, HttpServerException.class, Exception.class}, delay = 500)
...
public class SeguridadRestClient implements Serializable {
    ...
    public List<String> obtenerOperacionesPorCodigoUsuario(String codigoUsuario, List<Long> categoriasOperacionPk) throws HttpServerException, HttpClientException, HttpServerUnavailableException, BusinessException, Exception {
        ...
        if (categoriasOperacionPk != null) {
            for (Long pk : categoriasOperacionPk) {
                webTarget = webTarget.queryParam("categoriasOperacionPk", pk);
            }
        }
