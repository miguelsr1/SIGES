...
import sv.gob.mined.siges.negocio.servicios.CompromisoPresupuestarioBean;
...
/**
 * Servicios REST para el compromiso presupuestario
 * @author Sofis Solutions
 */
@RequestScoped
@Path("/v1/compromisos_presupuestarios")
@Tag(name = "Proveedor API V1")

public class CompromisoPresupuestarioRecurso {

    private static final Logger LOGGER = Logger.getLogger(CompromisoPresupuestarioRecurso.class.getName());

    @Inject
    private CompromisoPresupuestarioBean servicio;
    @Inject
     ...
     *
     * @param id Long
     * @return Response SgCompromisoPresupuestario
     */
    @POST
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Consumo satisfactorio.", content = @Content(
                ...
                schema = @Schema(implementation = SgCompromisoPresupuestario.class, type = SchemaType.ARRAY)))
        ,
    ...
    public Response buscar(FiltroCompromisoPresupuestario filtro) {
        try {
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Consumo satisfactorio.", content = @Content(
                mediaType = MediaType.APPLICATION_JSON,
                schema = @Schema(implementation = SgCompromisoPresupuestario.class)))
        ,
        @APIResponse(responseCode = "400", description = "Solicitud con sintaxis incorrecta.")
        ,
    ...
    public Response obtenerPorIdLazy(@PathParam("entityId") Long entityId) {
        try {
            SgCompromisoPresupuestario sede = servicio.obtenerPorIdLazy(entityId);
            if (sede == null) {
     ...
     *
     * @param com SgCompromisoPresupuestario
     * @return Response SgCompromisoPresupuestario
     */
    @POST
    ...
    public Response crear(SgCompromisoPresupuestario com) {
        try {
            com.setCprPk(null);
            com.setCprVersion(0);
     ...
     * @return Response Lista de SgCompromisoPresupuestario
     */
    @POST
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({ConstantesOperaciones.AUTENTICADO})
    public Response buscarTotal(FiltroCompromisoPresupuestario filtro) {
        try {
