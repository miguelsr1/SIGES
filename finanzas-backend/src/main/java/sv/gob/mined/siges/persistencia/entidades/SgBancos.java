...
@Entity
@Table(name = "sg_bancos", schema = Constantes.SCHEMA_CATALOGO)
@XmlRootElement
@EntityListeners(EntidadListener.class)
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class, property = "bncPk", scope = SgBancos.class)
@Audited
/**
 * Entidad correspondiente a los bancos (entidades bancarias).
 */
public class SgBancos implements Serializable {
    ...
    public void preSave() {
        ...
        this.bncCodigoBusqueda = SofisStringUtils.normalizarParaBusqueda(this.bncCodigoBusqueda);
    }
