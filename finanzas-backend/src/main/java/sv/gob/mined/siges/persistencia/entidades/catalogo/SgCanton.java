...
@Audited
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class, property = "canPk", scope = SgCanton.class)
/**
 * Entidad correspondiente a los cantones
 */
public class SgCanton implements Serializable {
    ...
    private SgMunicipio canMunicipioFk;
    ...
    public SgMunicipio getCanMunicipioFk() {
        return canMunicipioFk;
    }

    public void setCanMunicipioFk(SgMunicipio canMunicipioFk) {
