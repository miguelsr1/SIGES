...
@Audited
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, resolver = JsonIdentityResolver.class, property = "conPk", scope = SgConfiguracion.class)
/**
 * Entidad correspondiente a la gestión de configuración.
 */
...
public class SgConfiguracion implements Serializable {
    ...
    public String toString() {
        return "SgConfiguracion{" + "conPk=" + conPk + ", conCodigo=" + conCodigo + ", conNombre=" + conNombre + ", conNombreBusqueda=" + conNombreBusqueda + ", conHabilitado=" + conHabilitado + ", conUltModFecha=" + conUltModFecha + ", conUltModUsuario=" + conUltModUsuario + ", conVersion=" + conVersion + '}';
    }
