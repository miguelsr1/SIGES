...
/**
 * Servicios REST para la fuente de financiamiento
 * @author Sofis Solutions
 */
@RequestScoped
@Path("/v1/fuente/financiamiento")
...
public class FuenteFinanciamientoRecurso {
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Consumo satisfactorio.", content = @Content(
                ...
                schema = @Schema(implementation = SsFuenteFinanciamiento.class, type = SchemaType.ARRAY)))
        ,
