...
import sv.gob.mined.siges.negocio.servicios.RelCuentaTipoCuentaBean;
 ...
 */
public class RelCuentaTipoCuentaRecurso {

    private static final Logger LOGGER = Logger.getLogger(RelCuentaTipoCuentaRecurso.class.getName());

    @Inject
    private RelCuentaTipoCuentaBean servicio;
     ...
     * @return Response Lista de SgRelCuentaTipoCuenta
     */
    @POST
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Consumo satisfactorio.", content = @Content(
                ...
                schema = @Schema(implementation = SgRelCuentaTipoCuenta.class, type = SchemaType.ARRAY)))
        ,
    ...
    public Response buscar(FiltroRelCuentaTipoCuenta filtro) {
        try {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({ConstantesOperaciones.BUSCAR_CUENTAS_BANCARIAS})
    public Response buscarTotal(FiltroRelCuentaTipoCuenta filtro) {
        try {
