...
public class FiltroCalificacionCa implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 71 * hash + Objects.hashCode(this.ecaCalPk);
        hash = 71 * hash + Objects.hashCode(this.calCodigo);
        hash = 71 * hash + Objects.hashCode(this.calCodigoExacto);
        hash = 71 * hash + Objects.hashCode(this.calValor);
        hash = 71 * hash + Objects.hashCode(this.calOrden);
        hash = 71 * hash + Objects.hashCode(this.calHabilitado);
        hash = 71 * hash + Objects.hashCode(this.calEscala);
        hash = 71 * hash + Objects.hashCode(this.calEscalaExacto);
        hash = 71 * hash + Objects.hashCode(this.calEscalaCalificacionPk);
