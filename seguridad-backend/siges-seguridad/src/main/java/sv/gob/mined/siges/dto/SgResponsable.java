...
public class SgResponsable implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.personaEstudianteId, other.personaEstudianteId)) {
            return false;
        }
        if (!Objects.equals(this.personaResponsableId, other.personaResponsableId)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "SpResponsable{documento=" + documento + ", nombreCompleto=" + nombreCompleto + ", email=" + email;
    }
}