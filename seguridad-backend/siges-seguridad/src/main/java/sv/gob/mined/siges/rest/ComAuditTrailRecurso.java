...
import sv.gob.mined.siges.negocio.servicios.ComAuditTrailBean;
import sv.gob.mined.siges.constantes.ConstantesOperaciones;
import sv.gob.mined.siges.persistencia.entidades.ComAuditTrail;

@RequestScoped
@Path("/v1/comaudittrail")
@Tag(name = "ComAuditTrail API V1")
@DeclareRoles({ConstantesOperaciones.AUTENTICADO})
public class ComAuditTrailRecurso {

    private static final Logger LOGGER = Logger.getLogger(ComAuditTrailRecurso.class.getName());

    @Inject
    private ComAuditTrailBean servicio;

    /**
     * Devuelve el objeto que tiene el id indicado
     *
     * @param id Long
     * @return Response ComAuditTrail
     */
    @GET
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Consumo satisfactorio.", content = @Content(
                ...
                schema = @Schema(implementation = ComAuditTrail.class)))
        ,
    ...
    public Response obtenerPorId(@PathParam("id") Long id) {
        try {
            ComAuditTrail entity = servicio.obtenerPorId(id);
            if (entity == null) {
     ...
     * @return Response Lista de ComAuditTrail
     */
    @POST
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Consumo satisfactorio.", content = @Content(
                mediaType = MediaType.APPLICATION_JSON,
                schema = @Schema(implementation = ComAuditTrail.class, type = SchemaType.ARRAY)))
        ,
        @APIResponse(responseCode = "400", description = "Solicitud con sintaxis incorrecta.")
        ,
        @APIResponse(responseCode = "500", description = "Error interno del servidor.")}
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({ConstantesOperaciones.AUTENTICADO})
    public Response buscar(FiltroComAuditTrail filtro) {
        try {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({ConstantesOperaciones.AUTENTICADO})
    public Response buscarTotal(FiltroComAuditTrail filtro) {
        try {
