...
import sv.gob.mined.siges.negocio.servicios.RegistroAuditoriaBean;
import sv.gob.mined.siges.constantes.ConstantesOperaciones;

@RequestScoped
@Path("/v1/registrosauditoria")
@Tag(name = "RegistroAuditoria API V1")
@DeclareRoles({ConstantesOperaciones.AUTENTICADO})
public class RegistroAuditoriaRecurso {

    private static final Logger LOGGER = Logger.getLogger(RegistroAuditoriaRecurso.class.getName());

    @Inject
    private RegistroAuditoriaBean servicio;

    /**
     * Devuelve el objeto que tiene el id indicado
     *
     * @param id Long
     * @return Response RegistroAuditoria
     */
    @GET
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Consumo satisfactorio.", content = @Content(
                ...
                schema = @Schema(implementation = SgRegistroAuditoria.class)))
        ,
    ...
    public Response obtenerPorId(@PathParam("id") Long id) {
        try {
            SgRegistroAuditoria entity = servicio.obtenerPorId(id);
            if (entity == null) {
     ...
     * @return Response Lista de RegistroAuditoria
     */
    @POST
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Consumo satisfactorio.", content = @Content(
                mediaType = MediaType.APPLICATION_JSON,
                schema = @Schema(implementation = SgRegistroAuditoria.class, type = SchemaType.ARRAY)))
        ,
        @APIResponse(responseCode = "400", description = "Solicitud con sintaxis incorrecta.")
        ,
        @APIResponse(responseCode = "500", description = "Error interno del servidor.")}
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({ConstantesOperaciones.AUTENTICADO})
    public Response buscar(FiltroRegistroAuditoria filtro) {
        try {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({ConstantesOperaciones.AUTENTICADO})
    public Response buscarTotal(FiltroRegistroAuditoria filtro) {
        try {
