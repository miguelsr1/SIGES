...
import sv.gob.mined.siges.web.dto.SgDetalleSede;
import sv.gob.mined.siges.web.dto.catalogo.SgDireccion;
import sv.gob.mined.siges.web.dto.catalogo.SgJornadaLaboral;
import sv.gob.mined.siges.web.dto.catalogo.SgTipoCalendarioEscolar;
...
public abstract class SgSede implements Serializable {
    ...
    public String getSedTelefonos(){
        ...
        if(!StringUtils.isBlank(this.sedTelefono)){
            tels = this.sedTelefono;
        }
        
        if(!StringUtils.isBlank(this.sedTelefonoMovil)){
            if(StringUtils.isBlank(tels)){
                tels = this.sedTelefonoMovil;
            }else{
                tels += " - "+this.sedTelefonoMovil;
            }
        }
