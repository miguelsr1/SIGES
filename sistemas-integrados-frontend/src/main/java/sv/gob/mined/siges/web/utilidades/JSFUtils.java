...
import sv.gob.mined.siges.excepciones.Error;
...
public class JSFUtils {
    ...
    public static void agregarMensajes(String globalId, FacesMessage.Severity sev, List<Error> errores) {
        limpiarMensajesError();
    ...
    public static void agregarMensajesError(String globalId, FacesMessage.Severity sev, List<BusinessError> errores) {
        limpiarMensajesError();
        for (int i = 0; i < errores.size(); i++) {
