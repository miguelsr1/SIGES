...
import sv.gob.mined.siges.web.dto.centros_educativos.SgUsuario;
...
public class UsuarioRestClient implements Serializable {
    ...
    @Retry(maxRetries = 3, retryOn = {HttpServerUnavailableException.class, HttpServerException.class, Exception.class, TimeoutException.class}, delay = 250)
