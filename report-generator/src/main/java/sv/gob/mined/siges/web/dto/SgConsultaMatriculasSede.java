...
public class SgConsultaMatriculasSede implements Serializable {
    ...
    public String toString() {
        return "SgConsultaMatriculasSede{" + "nivelNombre=" + nivelNombre + ", cicloNombre=" + cicloNombre + ", modalidadEduNombre=" + modalidadEduNombre + ", modalidadAtenNombre=" + modalidadAtenNombre + ", gradoNombre=" + gradoNombre + ", cantMatMasculino=" + cantMatMasculino + ", cantMatFemenino=" + cantMatFemenino + '}';
    }
