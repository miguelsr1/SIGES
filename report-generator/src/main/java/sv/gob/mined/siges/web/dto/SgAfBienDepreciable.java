...
public class SgAfBienDepreciable implements Serializable {
    ...
    public String getBdeNombreCategoria() {
        if(bdeTipoBienCategoriaVinculada != null && bdeTipoBien != null) {
            if(bdeTipoBienCategoriaVinculada) {
                return bdeTipoBien.getTbiCategoriaBienes().getCabNombre();
            } else if(bdeCategoriaFk != null) {
