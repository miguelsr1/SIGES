...
public class SgTitulo implements Serializable {
    ...
    public String getTitCentroCodigoNombre() {
        return this.titSedeCodigo + " - " + this.titSedeNombre;
    }
    
    public String getTitNombreTituloReposicion(){
        if(!StringUtils.isBlank(titTituloAnterior2008)){
            return titTituloAnterior2008;
        }else{
            if(!StringUtils.isBlank(titNombreTituloPosterior2008)){
