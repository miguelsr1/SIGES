...
public class CalificacionesEstudiantesTestOld extends AbstractReportGenerator {

    /**
     * Default constructor for this sample report generator
     */
    public CalificacionesEstudiantesTestOld() {
    }
    ...
    public MasterReport getReportDefinition() {
        try {
            ...
            final URL reportDefinitionURL = classloader.getResource("calificaciones_estudiantes1.prpt");
    ...
    public DataFactory getDataFactory() {
        ...
        model.addRow("2", "1001 - Centro Escolar Isidro Menéndez", "2018", "PL2015 - GENERAL - REGULAR", "PRIMERO","A - Matutino", "Luis Juan Pérez", "EDUCACIÓN MEDIA - TÉCNICO VOCACIONAL - ACUICULTURA - MEGATEC - FELXIBLE - NOCTURNA",1,2,3, 3, a3);
        model.addRow("33332", "1001 - Centro Escolar Isidro Menéndez", "2018", "PL2015 - GENERAL - REGULAR","PRIMERO", "A - Matutino", "Roberto González", "EDUCACIÓN MEDIA - TÉCNICO VOCACIONAL - ACUICULTURA - MEGATEC - FELXIBLE - NOCTURNA",1,2,3, 4, a4);
        model.addRow("11111", "1001 - Centro Escolar Isidro Menéndez", "2018", "PL2015 - GENERAL - REGULAR", "PRIMERO","A - Matutino", "Federico Andrés Pérez", "EDUCACIÓN MEDIA - TÉCNICO VOCACIONAL - ACUICULTURA - MEGATEC - FELXIBLE - NOCTURNA",1,2,3, 5, a5);
    ...
    public static void main(String[] args) throws IOException, ReportProcessingException {
        ...
        final File outputFilename = new File(CalificacionesEstudiantesTestOld.class.getSimpleName() + ".pdf");

        // Generate the report
        new CalificacionesEstudiantesTestOld().generateReport(AbstractReportGenerator.OutputType.PDF, outputFilename);
