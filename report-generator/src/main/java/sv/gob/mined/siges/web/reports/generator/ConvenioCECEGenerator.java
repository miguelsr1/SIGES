...
@Named
@RequestScoped
public class ConvenioCECEGenerator {
    
    private static final Logger LOGGER = Logger.getLogger(ConvenioCECEGenerator.class.getName());
    ...
    public MasterReport generarReporte(Long sedeId) throws Exception {
       try {
            ...
            if (BooleanUtils.isTrue(utilizarPlantillasExternas)) {
                SgPlantilla plantilla = plantillaClient.obtenerPorCodigo(Constantes.PLANTILLA_CONVENIO_CECE);
                if (plantilla == null || plantilla.getPlaArchivo() == null) {
                    be.addError("Plantilla " + Constantes.PLANTILLA_CONVENIO_CECE + " inexistente.");
                    throw be;
                }
                ...
                reportDefinitionURL = classloader.getResource("CONVCECE.prpt");
            }
            ...
            if(sede.getSedDireccion() != null && sede.getSedDireccion().getDirDepartamento() != null && sede.getSedDireccion().getDirDepartamento().getDepPk() != null) {
                ...
                fdireccion.setDedDepartamentoFk(sede.getSedDireccion().getDirDepartamento());
                ...
                fdireccion.setIncluirCampos(new String[]{"decDirectorNombre","decDirectorCargo"});          
    ...
    private DataFactory getDataFactory(SgSede sede, SgDireccionDepartamental departamental, List<SgPersonaOrganismoAdministracion> listaOrganismoEscolar) throws Exception {
        ...
        String name1 = StringUtils.EMPTY;
        ...
        String fechaExtensionPresidente = StringUtils.EMPTY;
                ...
                if(poa.getPoaCargo() != null && poa.getPoaCargo().getCoaCodigo() != null) {
                   ...
                   if(poa.getPoaCargo().getCoaCodigo().trim().equals(Constantes.CODIGO_PRESIDENTE_CECE)) {
                        if(preregistrado) {
                            ...
                            fechaExtensionPresidente = poa.getPoaFechaExpedicionDUI() != null ? Generales.getDateFormat(poa.getPoaFechaExpedicionDUI(),"dd/MM/yyyy") : "";
                        } else {
        ...
        model.addColumn("name_1", String.class);
        ...
        model.addRow(
                    ...
                    fechaExtensionPresidente,//fecha_extension_presidente
                    ...
                    cargoTesorero,//cargo_tesorero
                    niveles,//name_4
                    departamentoUnidad,//convenio1
                    name1,//name_1
