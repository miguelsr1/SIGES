...
@WebServlet(name = "promocionesEstudiantesMobileServlet ", urlPatterns = "/ma/promocionesEstudiantes")
public class PromocionesEstudiantesMobile extends HttpServlet {

    private static final long serialVersionUID = 1L;

    private static final Logger LOGGER = Logger.getLogger(PromocionesEstudiantesMobile.class.getName());
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (!claims.getStringListClaimValue("groups").contains(ConstantesOperaciones.GENERAR_PROMOCION_ESTUDIANTE)) {
