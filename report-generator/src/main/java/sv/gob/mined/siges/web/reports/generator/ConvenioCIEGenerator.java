...
@Named
@RequestScoped
public class ConvenioCIEGenerator {   
    ...
    public MasterReport generarReporte(Long sedeId) throws Exception {
       try {
            ...
            if (BooleanUtils.isTrue(utilizarPlantillasExternas)) {
                SgPlantilla plantilla = plantillaClient.obtenerPorCodigo(Constantes.PLANTILLA_CONVENIO_CIE);
                if (plantilla == null || plantilla.getPlaArchivo() == null) {
                    be.addError("Plantilla " + Constantes.PLANTILLA_CONVENIO_CIE + " inexistente.");
                    throw be;
                }
                ...
                reportDefinitionURL = classloader.getResource("CONVCIE.prpt");
            }
            ...
            codigos.add(Constantes.CODIGO_CIE);
